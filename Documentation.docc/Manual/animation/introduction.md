...
The [AnimationPlayer](https://docs.godotengine.org/en/stable/classes/class_animationplayer.html#class-animationplayer) node allows you to create anything
...
@Image(source: "animation_create_animationplayer.png", alt: "The AnimationPlayer node") {The AnimationPlayer node}

After you create an AnimationPlayer node, click on it to
open the Animation Panel at the bottom of the viewport.

@Image(source: "animation_animation_panel.png", alt: "The animation panel position") {The animation panel position}

The animation panel consists of four parts:

@Image(source: "animation_animation_panel_overview.png", alt: "The animation panel") {The animation panel}
...
@Image(source: "animation_keyframes.png", alt: "Keyframes in Godot") {Keyframes in Godot}
...
@Image(source: "animation_illustration.png", alt: "Two keyframes are all it takes to obtain a smooth motion") {Two keyframes are all it takes to obtain a smooth motion}

The timeline defines how long the animation will take. You can insert keyframes
at various points, and change their timing.

@Image(source: "animation_timeline.png", alt: "The timeline in the animation panel") {The timeline in the animation panel}
...
@Image(source: "animation_animation_player_tree.png", alt: "Our scene setup") {Our scene setup}
...
@Image(source: "animation_create_new_animation.png", alt: "Add a new animation") {Add a new animation}
...
@Image(source: "animation_library.png", alt: "Manage animations") {Manage animations}

If there are multiple animation libraries and you try to add an animation, a dialog box will appear with options.

@Image(source: "animation_library_dialog.png", alt: "Add a new animation with library option") {Add a new animation with library option}
...
@Image(source: "animation_convenience_buttons.png", alt: "Convenience buttons") {Convenience buttons}
...
@Image(source: "animation_track.png", alt: "The sprite track") {The sprite track}
...
@Image(source: "animation_set_length.png", alt: "Animation length") {Animation length}
...
@Image(source: "animation_simple.gif", alt: "The animation") {The animation}
...
@Image(source: "autoplay_on_load.png")
...
@Image(source: "animation_loop.png", alt: "Animation loop") {Animation loop}
...
@Image(source: "animation_track_settings.png", alt: "Track settings") {Track settings}
...
@Image(source: "animation_track_rate.png", alt: "Track mode") {Track mode}
...
@Image(source: "animation_track_interpolation.png", alt: "Track interpolation") {Track interpolation}
...
@Image(source: "animation_track_loop_modes.png", alt: "Loop modes") {Loop modes}
...
@Image(source: "animation_properties_keyframe.png", alt: "Keyframes for other properties") {Keyframes for other properties}
...
@Image(source: "animation_keyframe_editor_key.png", alt: "Keyframe editor editing a key") {Keyframe editor editing a key}
...
> Note: RESET tracks are also used as reference values for blending. See also For better blending.
>
...
@Image(source: "animation_marker_click_area.png")
...
@Image(source: "animation_marker_selected.png")
