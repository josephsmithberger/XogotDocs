...
Traditionally, cutout animation
is a type of stop motion animation
...
[Polygon2D](https://docs.godotengine.org/en/stable/classes/class_polygon2d.html#class-polygon2d)
...
@Image(source: "tuto_cutout_walk.gif")

Get your assets:
cutout_animation_assets.zip.

## Setting up the rig

Create an empty Node2D as root of the scene, we will work under it:

@Image(source: "tuto_cutout1.png")
...
@Image(source: "tutovec_torso1.gif")

The rotation pivot is wrong and needs to be adjusted.

This small cross in the middle of the [Sprite2D](https://docs.godotengine.org/en/stable/classes/class_sprite2d.html#class-sprite2d) is
the rotation pivot:

@Image(source: "tuto_cutout4.png")
...
@Image(source: "tutovec_torso2.gif")
...
The [RemoteTransform2D](https://docs.godotengine.org/en/stable/classes/class_remotetransform2d.html#class-remotetransform2d) node transforms nodes
...
@Image(source: "tutovec_torso4.gif")
...
@Image(source: "tuto_cutout10.png")
...
but [Marker2D](https://docs.godotengine.org/en/stable/classes/class_marker2d.html#class-marker2d) is preferred because it's
visible in the editor. The endpoint node will ensure that the last bone
has orientation.

@Image(source: "tuto_cutout14.png")

Now select the whole chain, from the endpoint to the arm and create
bones:

@Image(source: "tuto_cutout15.png")
...
@Image(source: "tuto_cutout15_2.png")

Your final skeleton should look something like this:

@Image(source: "tuto_cutout16.png")
...
@Image(source: "tutovec_torso5.gif")
...
@Image(source: "tuto_cutout20.png")
...
@Image(source: "tuto_cutout21.png")
...
@Image(source: "tuto_cutout22.png")
...
@Image(source: "tuto_cutout23.png")
...
1. Click on the pencil icon in the bottom right of the animation panel. This
will open the transition editor.

1. In the transition editor, click on the desired curve to apply it.

@Image(source: "tuto_cutout24.png")
...
This process is described in a <doc:2d_skeletons>.