...
- Recording cutscenes that will be <doc:playing_videos>
...
<doc:creating_movies#Motion-Blur>.
...
>
> Players should use something like OBS Studio or
...
@Image(source: "creating_movies_enable_movie_maker_mode.png", alt: "Movie Maker mode is disabled, click the "movie reel" icon to enable") {Movie Maker mode is disabled, click the "movie reel" icon to enable}
...
@Image(source: "creating_movies_disable_movie_maker_mode.png", alt: "Movie Maker mode is enabled, click the "movie reel" icon again to disable") {Movie Maker mode is enabled, click the "movie reel" icon again to disable}
...
Movie Maker can also be enabled from the <doc:command_line_tutorial>:
...
<doc:creating_movies#Recording-At-Higher-Resolution> if you need to record
...
Output formats are provided by the [MovieWriter](https://docs.godotengine.org/en/stable/classes/class_moviewriter.html#class-moviewriter) class.
Godot has 3 built-in [MovieWriters](https://docs.godotengine.org/en/stable/classes/class_moviewriter.html#class-moviewriter), and more can be
...
> On the other hand, <doc:playing_videos>
...
>
> See also <doc:creating_movies#Recording-At-Higher-Resolution>.
>
...
others will require a conversion step beforehand. HandBrake
(GUI) and FFmpeg (CLI) are popular open source tools
...
See <doc:creating_movies#Reducing-Framerate> if you want to get this benefit
