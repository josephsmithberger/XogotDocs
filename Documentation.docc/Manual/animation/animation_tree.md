...
With [AnimationPlayer](https://docs.godotengine.org/en/stable/classes/class_animationplayer.html#class-animationplayer), Godot has one of the most flexible animation systems that you can find in any game engine.
...
@Image(source: "animtree_blend2.gif")
...
@Image(source: "animtree_filtering.png")
...
@Image(source: "animtree_timescale.png")
...
@Image(source: "animtree_connections.gif")

There are 3 types of transitions:

@Image(source: "animtree_transitiontypes.png")
...
@Image(source: "animtree_statemachinetransitionproperties.png")
...
@Image(source: "animtree_badanimcondition.png")
...
@Image(source: "animtree_goodanimcondition.png")

@Image(source: "animtree_goodanimcondition.gif")
...
@Image(source: "animtree_goodanimexpression.png")

@Image(source: "animtree_goodanimexpression2.png")

@Image(source: "animtree_goodanimexpression.gif")
...
@Image(source: "animtree_blendspacepoints.gif")
...
@Image(source: "animtree_rootmotiontrack.png")
