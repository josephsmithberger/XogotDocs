...
1. Animation Root nodes, which are used to blend sub-nodes.

1. Animation Blend nodes, which are used within AnimationNodeBlendTree as single-graph blending via multiple input ports.

To set a root node in AnimationTree, a few types are available:

@Image(source: "animtree2.png")
...
@Image(source: "animtree11.gif")

There are many types of transition:

@Image(source: "animtree12.png")
