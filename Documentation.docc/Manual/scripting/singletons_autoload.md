...
> Note:
>
> When autoloading a script, a [Node](https://docs.godotengine.org/en/stable/classes/class_node.html#class-node) will be created and the script will be
...
@Image(source: "autoload_example.png")
...
@Image(source: "autoload_runtime.png")
...
@Image(source: "autoload_tutorial1.png")
...
> To learn how to handle this, see the next tutorial: <doc:background_loading>.
>
