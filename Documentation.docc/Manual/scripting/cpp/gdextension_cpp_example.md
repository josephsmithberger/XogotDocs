...
As a GDExtension, godot-cpp is more complicated to use than <doc:index> and <doc:index>.
...
You can download the godot-cpp repository from GitHub or let Git do the work for you.
...
You can learn more about `.gdextension` files at <doc:gdextension_file>.
...
@Image(source: "gdextension_cpp_nodes.png")

We're going to assign the Godot logo to this node as our texture, disable the
`centered` property:

@Image(source: "gdextension_cpp_sprite.png")
...
To learn more about `Callable`, check out the class reference here: [Callable](https://docs.godotengine.org/en/stable/classes/class_callable.html#class-callable).
