...
[OS](https://docs.godotengine.org/en/stable/classes/class_os.html#class-os) class,
...
When initialization is complete, [OS](https://docs.godotengine.org/en/stable/classes/class_os.html#class-os) needs to be
supplied a [MainLoop](https://docs.godotengine.org/en/stable/classes/class_mainloop.html#class-mainloop)
...
The scene system is the game engine, while the [OS](https://docs.godotengine.org/en/stable/classes/class_os.html#class-os)
...
- It contains the root [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport), to which a
...
The root [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport)
...
1. The root node of that scene (only one root, remember?) is added as
...
loading. This must be done manually using <doc:singletons_autoload>
and <doc:background_loading>.