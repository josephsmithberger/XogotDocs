...
**Rule ID** | GD0401
**Category** | Usage
**Fix is breaking or non-breaking** | Breaking - If changing the inheritance chainNon-breaking - If removing the[GlobalClass]attribute
...
Every <doc:c_sharp_global_classes> must ultimately derive from
