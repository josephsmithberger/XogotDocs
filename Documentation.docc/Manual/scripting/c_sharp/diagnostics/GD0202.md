...
**Rule ID** | GD0202
**Category** | Usage
**Fix is breaking or non-breaking** | Breaking - If the parameter type is changedNon-breaking - If the`[Signal]`attribute is removed
...
Take a look at the <doc:c_sharp_signals> documentation for more
