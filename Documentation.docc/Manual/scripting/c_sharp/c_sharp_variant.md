...
For a detailed explanation of Variant in general, see the [Variant](https://docs.godotengine.org/en/stable/classes/class_variant.html#class-variant) documentation page.

Godot.Variant is used to represent Godot's native [Variant](https://docs.godotengine.org/en/stable/classes/class_variant.html#class-variant) type. Any
...
- All the built-in value types,
except decimal, nint and nuint.

- string.

- Classes derived from [GodotObject](https://docs.godotengine.org/en/stable/classes/class_object.html#class-object).
...
Rid | Godot.Rid
Object | Godot.GodotObjector any derived type.
