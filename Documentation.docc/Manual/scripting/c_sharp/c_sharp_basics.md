...
<doc:c_sharp_features>, read about the
<doc:c_sharp_differences>,
and (re)visit the <doc:scripting_languages> of the
...
> experimental and <doc:index#Platforms>.
>
...
.NET support in your build as outlined in the <doc:compiling_with_dotnet>
page.
...
or Visual Studio. These provide autocompletion, debugging, and other
...
@Image(source: "attachcsharpscript.png")
...
the tutorials on <doc:scripting_languages> at this point.
...
@Image(source: "build_dotnet.png") {You will also need to rebuild the project assemblies to apply changes in
"tool" scripts.}
...
Since C# 10, it is also possible to use with expressions
