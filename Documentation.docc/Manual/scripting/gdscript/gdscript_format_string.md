...
v | A**vector**. Expects any float or int-based vector object (Vector2,Vector3,Vector4,Vector2i,Vector3iorVector4i). Will display the vector coordinates in parentheses,
...
When used after., see..
. | Beforeforv, set**precision**to 0 decimal places. Can
...
> vformat() helper function in the [Variant](https://docs.godotengine.org/en/stable/classes/class_variant.html#class-variant) header.