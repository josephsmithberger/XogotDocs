...
As explained in the <doc:debugger_panel> documentation, Godot features a
...
The main scene features a [Timer](https://docs.godotengine.org/en/stable/classes/class_timer.html#class-timer) node with the following script attached:
...
@Image(source: "custom_performance_monitors_graph_example.png", alt: "Example editor graph from a custom performance monitor") {Example editor graph from a custom performance monitor}
...
> monitor registration and getter function to an <doc:singletons_autoload> instead.
>
