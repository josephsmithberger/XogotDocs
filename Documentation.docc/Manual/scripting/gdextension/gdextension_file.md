...
how to get started with GDExtensions take a look at the <doc:gdextension_cpp_example>.
...
**android_aar_plugin** | Boolean | The GDExtension is part of a <doc:android_plugin>. During export this flag
