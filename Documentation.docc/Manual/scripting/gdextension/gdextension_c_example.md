...
inherits from [Sprite2D](https://docs.godotengine.org/en/stable/classes/class_sprite2d.html#class-sprite2d).
...
create a [StringName](https://docs.godotengine.org/en/stable/classes/class_stringname.html#class-stringname) and for that we have to get a
...
See <doc:what_is_gdextension#Version-Compatibility> for more information.
...
are working on for the example. Using <doc:feature_tags> you
...
@Image(source: "gdextension_c_running.png")
...
this tutorial, check the page about the <doc:object_class>
...
@Image(source: "gdextension_c_methods_doc.png")
...
@Image(source: "gdextension_c_inspector_properties.png")
...
First, let's add [Vector2](https://docs.godotengine.org/en/stable/classes/class_vector2.html#class-vector2) to our defs.h file, so we
...
@Image(source: "gdextension_c_moving_sprite.gif")
...
@Image(source: "gdextension_c_signal_doc.png")
...
@Image(source: "gdextension_c_signal_print.png")
