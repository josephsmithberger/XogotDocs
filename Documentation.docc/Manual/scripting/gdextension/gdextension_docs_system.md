...
> Note:
>
> We are assuming you are using the project files explained in the <doc:gdextension_cpp_example>
...
To style specific parts of text you can use BBCode tags similarly to how they can be used in <doc:bbcode_in_richtextlabel>.
