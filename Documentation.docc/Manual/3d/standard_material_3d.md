...
@Image(source: "spatial_material1.png")
...
@Image(source: "spatial_material12.png")
...
regions. While it's possible to use post-processing-based <doc:3d_antialiasing> such as FXAA and TAA, this is not always
...
@Image(source: "material_depth_draw.png")
...
@Image(source: "standard_material_shading_modes.png", alt: "Three spheres showing the Per-Pixel, Per-Vertex, and Unshaded modes.")
...
@Image(source: "standard_material_shading_modes_textured.png", alt: "Two cubes with a brick texture, one shaded and one unshaded.") {Texture from AmbientCG}
...
@Image(source: "spatial_material6.png")
...
@Image(source: "spatial_material7.png")
...
@Image(source: "spatial_material4.png")
...
@Image(source: "spatial_material14.png")

## Emission

Emission specifies how much light is emitted by the material (keep in mind this
does not include light surrounding geometry unless <doc:using_voxel_gi>
or <doc:using_sdfgi> are used). This value is added to the resulting
final image and is not affected by other lighting in the scene.

@Image(source: "spatial_material15.png")
...
@Image(source: "spatial_material16.png")
...
@Image(source: "clearcoat_comparison.png")
...
@Image(source: "spatial_material18.png")
...
@Image(source: "spatial_material19.png")
...
for physics collision (such as terrain), see [HeightMapShape3D](https://docs.godotengine.org/en/stable/classes/class_heightmapshape3d.html#class-heightmapshape3d). It
...
@Image(source: "spatial_material20.png")
...
@Image(source: "spatial_material21.png")
...
@Image(source: "spatial_material23.png")
...
@Image(source: "spatial_material24.png")
...
@Image(source: "spatial_material25.png")
...
specifying <doc:process_material_properties_animation>.

@Image(source: "spatial_material9.png")
...
@Image(source: "spatial_material10.png")
...
@Image(source: "spatial_material11.png")
...
@Image(source: "spatial_material_proxfade.gif")
...
@Image(source: "standart_material_distance_fade_pixel_alpha_mode.png")

**Pixel Dither** mode: What this does is sort of approximate the transparency
by only having a fraction of the pixels rendered.

@Image(source: "standart_material_distance_fade_pixel_dither_mode.png")
