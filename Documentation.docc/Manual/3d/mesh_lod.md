...
performance in a 3D project, along with <doc:occlusion_culling>.
...
> Occlusion Culling and Mesh LOD demo project.
>
...
The meshoptimizer library is used for LOD mesh
...
@Image(source: "mesh_lod_comparison_shaded.png", alt: "From most detailed (left) to least detailed (right), shaded view") {From most detailed (left) to least detailed (right), shaded view}

Here's the same image with wireframe rendering to make the decimation easier to see:

@Image(source: "mesh_lod_comparison_wireframe.png", alt: "From most detailed (left) to least detailed (right), wireframe view") {From most detailed (left) to least detailed (right), wireframe view}

> Seealso:
>
> If you need to manually configure level of detail with artist-created meshes,
> use <doc:visibility_ranges> instead of automatic mesh LOD.
>
...
@Image(source: "mesh_lod_obj_import.png", alt: "Changing the import type on an OBJ file in the Import dock") {Changing the import type on an OBJ file in the Import dock}
...
>
> See <doc:index#Using-The-Import-Dock>
...
@Image(source: "mesh_lod_disable_lod.png", alt: "Disabling mesh LOD in the 3D viewport's top-left menu") {Disabling mesh LOD in the 3D viewport's top-left menu}
...
>
> As a result, unlike <doc:visibility_ranges>, you don't need to do
