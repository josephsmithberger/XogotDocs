...
The [Environment](https://docs.godotengine.org/en/stable/classes/class_environment.html#class-environment) resource stores all the information required for
...
@Image(source: "environment_camera.png")
...
@Image(source: "environment_world.png")
...
@Image(source: "environment_preview_sun_sky_toggle.png")
...
@Image(source: "environment_preview_sun_sky_dialog.png")
...
The [CameraAttributes](https://docs.godotengine.org/en/stable/classes/class_cameraattributes.html#class-cameraattributes) resource stores exposure and depth of field
...
> Note:
>
> Using a [CameraAttributesPhysical](https://docs.godotengine.org/en/stable/classes/class_cameraattributesphysical.html#class-cameraattributesphysical) on a Camera3D node will lock
...
@Image(source: "environment_background1.png")
...
<doc:environment_and_post_processing#Using-Glow-In-2d>.
...
create a custom <doc:sky_shader>.
...
@Image(source: "environment_ambient2.png")
...
generate ambient light from <doc:reflection_probes>,
<doc:using_voxel_gi> or <doc:using_sdfgi>, as these
...
@Image(source: "environment_ambient_comparison.png")
...
> It is possible to use both non-volumetric fog and <doc:volumetric_fog>
> at the same time.
>
...
@Image(source: "environment_fog_depth_height.png")
...
@Image(source: "environment_fog_transmission.png")

> Note:
>
> Fog can cause banding to appear on the viewport, especially at
> higher density levels. See <doc:3d_rendering_limitations#Color-Banding>
...
> Seealso:
>
> See <doc:volumetric_fog> for documentation on setting up volumetric fog.
>
...
<doc:reflection_probes>, they may not provide enough detail for all
...
@Image(source: "environment_ssr.png")
...
@Image(source: "environment_ssao.png")
...
@Image(source: "environment_ssao2.png")

Tweaking :abbr:`SSAO (Screen-Space Ambient Occlusion)` is possible with several
parameters:

@Image(source: "environment_ssao_parameters.png")
...
@Image(source: "environment_ssil.png")
...
> Seealso:
>
> See <doc:using_sdfgi> for instructions on setting up this global
> illumination technique.
>

@Image(source: "environment_sdfgi.png")
...
@Image(source: "environment_glow1.png")
...
<doc:environment_and_post_processing#Using-Glow-To-Blur-The-Screen>
...
@Image(source: "environment_glow_map.png")
...
@Image(source: "environment_and_post_processing_glow_scale_mode.png")
...
[CanvasLayer](https://docs.godotengine.org/en/stable/classes/class_canvaslayer.html#class-canvaslayer) node. You can control which layers are affected by
...
when using the Canvas background mode, make them children of a [CanvasLayer](https://docs.godotengine.org/en/stable/classes/class_canvaslayer.html#class-canvaslayer)
...
@Image(source: "environment_adjustments.png")
...
@Image(source: "environment_adjustments_bcs.png")
...
@Image(source: "environment_adjustments_default_gradient.png")

But creating custom ones will allow to map each channel to a different color:

@Image(source: "environment_adjustments_custom_gradient.png")
...
@Image(source: "environment_adjustments_3d_lut_import.png")
...
@Image(source: "environment_adjustments_3d_lut_comparison.png")
...
@Image(source: "environment_dof_far.png")
...
@Image(source: "environment_dof_near.png")
...
@Image(source: "environment_mixed_blur.png")
...
@Image(source: "environment_hdr_autoexp.png")
...
By combining Auto Exposure with <doc:environment_and_post_processing#Glow>
