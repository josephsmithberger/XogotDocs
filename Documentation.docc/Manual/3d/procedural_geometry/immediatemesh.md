...
First, you need to create a [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d) and add
an [ImmediateMesh](https://docs.godotengine.org/en/stable/classes/class_immediatemesh.html#class-immediatemesh) to it in the Inspector.
...
the [Mesh](https://docs.godotengine.org/en/stable/classes/class_mesh.html#class-mesh) class reference page.
