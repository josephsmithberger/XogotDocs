...
[Gridmaps](https://docs.godotengine.org/en/stable/classes/class_gridmap.html#class-gridmap) are a tool for creating 3D
game levels, similar to the way <doc:using_tilemaps>
works in 2D. You start with a predefined collection of 3D meshes (a
[MeshLibrary](https://docs.godotengine.org/en/stable/classes/class_meshlibrary.html#class-meshlibrary)) that can be placed on a grid,
...
To begin, you need a [MeshLibrary](https://docs.godotengine.org/en/stable/classes/class_meshlibrary.html#class-meshlibrary), which is a collection
...
@Image(source: "gridmap_meshlibrary1.png")

As you can see, this scene has a [Node3D](https://docs.godotengine.org/en/stable/classes/class_node3d.html#class-node3d) node as its root, and
a number of [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d) node children.
...
You can manually assign a [StaticBody3D](https://docs.godotengine.org/en/stable/classes/class_staticbody3d.html#class-staticbody3d) and
[CollisionShape3D](https://docs.godotengine.org/en/stable/classes/class_collisionshape3d.html#class-collisionshape3d) to each mesh. Alternatively, you can use the "Mesh" menu
to automatically create the collision body based on the mesh data.

@Image(source: "gridmap_create_body.png")
...
@Image(source: "gridmap_mesh_scene.png")
...
Like all mesh instances, MeshLibrary items can be assigned a [NavigationMesh](https://docs.godotengine.org/en/stable/classes/class_navigationmesh.html#class-navigationmesh)
...
[NavigationRegion3D](https://docs.godotengine.org/en/stable/classes/class_navigationregion3d.html#class-navigationregion3d) child node below the main MeshInstance3D for the GridMap
...
@Image(source: "meshlibrary_scene.png")
...
See <doc:using_lightmap_gi> for more information about lightmap baking.
...
- Be a [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d), which will become the MeshLibrary item. Only
this visual mesh will be exported.

- Have a material, in the mesh's material slot, not the MeshInstance3D's
material slots.

- Have up to one [StaticBody3D](https://docs.godotengine.org/en/stable/classes/class_staticbody3d.html#class-staticbody3d) child, for collision. The
StaticBody3D should have one or more [CollisionShape3D](https://docs.godotengine.org/en/stable/classes/class_collisionshape3d.html#class-collisionshape3d) children.

- Have up to one [NavigationRegion3D](https://docs.godotengine.org/en/stable/classes/class_navigationregion3d.html#class-navigationregion3d) child, for navigation. The
NavigationRegion3D can have one or more additional [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d)
...
@Image(source: "gridmap_mesh_library_inspector.png")
...
@Image(source: "gridmap_mesh_library_settings.png")
...
@Image(source: "gridmap_panel.png")
...
@Image(source: "gridmap_dropdown.png")
