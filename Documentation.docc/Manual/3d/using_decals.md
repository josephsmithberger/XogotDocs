...
> <doc:3d_text> placed close to a surface instead of a Decal node.
>
...
@Image(source: "decals_dirt.png", alt: "Dirt added on top of level geometry using decals") {Dirt added on top of level geometry using decals}
...
@Image(source: "decals_blob_shadow.png", alt: "Blob shadow under object comparison") {Blob shadow under object comparison}
...
1. In the inspector, expand the **Textures** section and load a texture in
**Textures > Albedo**.

1. Move the Decal node towards an object, then rotate it so the decal is visible
...
1. If your decal is meant to affect static objects only, configure it to prevent
...
@Image(source: "decals_sorting_offset.png", alt: "VisualInstance3D Sorting Offset comparison on Decals") {VisualInstance3D Sorting Offset comparison on Decals}
...
[Rendering > Textures > Decals > Filter](https://docs.godotengine.org/en/stable/classes/class_projectsettings_property_rendering/textures/decals/filter.html#class-projectsettings_property_rendering/textures/decals/filter)
