...
<doc:standard_material_3d#Alpha-Antialiasing>
...
@Image(source: "antialiasing_taa.png")
...
2.2. This is an <doc:resolution_scaling>
...
@Image(source: "antialiasing_fsr2_native.png")
...
@Image(source: "antialiasing_ssaa_2.25x.png")

@Image(source: "antialiasing_ssaa_4x.png")
...
<doc:creating_movies>. For example, to make
