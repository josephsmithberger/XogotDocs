...
@Image(source: "occlusion_culling_scene_example.png", alt: "Example scene with an occlusion culling-friendly layout") {Example scene with an occlusion culling-friendly layout}
...
@Image(source: "occlusion_culling_disabled.png", alt: "Example scene with occlusion culling disabled (wireframe)") {Example scene with occlusion culling **disabled** (wireframe)}
...
@Image(source: "occlusion_culling_enabled.png", alt: "Example scene with occlusion culling enabled (wireframe)") {Example scene with occlusion culling **enabled** (wireframe)}
...
this with <doc:mesh_lod> and <doc:visibility_ranges> to further improve
performance gains.
...
the software raytracing library Embree.
...
<doc:occlusion_culling#Troubleshooting-False-Negative>.
...
<doc:occlusion_culling#Preview> to look
for occluder shapes that shouldn't be present, then
<doc:occlusion_culling#Baking>.
