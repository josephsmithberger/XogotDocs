...
> have a [CameraAttributes](https://docs.godotengine.org/en/stable/classes/class_cameraattributes.html#class-cameraattributes) resource assigned to the
...
On the Camera3D node, you can add a [CameraAttributes](https://docs.godotengine.org/en/stable/classes/class_cameraattributes.html#class-cameraattributes)
resource to its **Attributes** property. This resource is used to control the
camera's depth of field and exposure. When using
[CameraAttributesPhysical](https://docs.godotengine.org/en/stable/classes/class_cameraattributesphysical.html#class-cameraattributesphysical), its focal length property is also used to
...
See <doc:physical_light_and_camera_units#Setting-Up-Physical-Camera-Units>
...
If you haven't added a [WorldEnvironment](https://docs.godotengine.org/en/stable/classes/class_worldenvironment.html#class-worldenvironment) and [Camera3D](https://docs.godotengine.org/en/stable/classes/class_camera3d.html#class-camera3d)
...
the [Environment](https://docs.godotengine.org/en/stable/classes/class_environment.html#class-environment) resource:
...
- **Intensity:** The light's intensity in lux (DirectionalLight3D) or
lumens (OmniLight3D/SpotLight3D).
...
@Image(source: "physical_light_units_color_temperature_chart.png", alt: "Color temperature chart from 1,000 Kelvin (left) to 12,500 Kelvin (right)") {Color temperature chart from 1,000 Kelvin (left) to 12,500 Kelvin (right)}
...
After adding a [CameraAttributesPhysical](https://docs.godotengine.org/en/stable/classes/class_cameraattributesphysical.html#class-cameraattributesphysical) resource to the **Camera
