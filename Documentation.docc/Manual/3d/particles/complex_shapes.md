...
@Image(source: "particle_complex_emission.png", alt: "Complex emission shapes")

When it is not enough to emit particles from one of the simple shapes available
in the <doc:process_material_properties_shapes>, Godot provides
...
@Image(source: "particle_create_emission_points.png", alt: "Creating emission points") {Create particle emission points...}

@Image(source: "particle_select_emission_mesh.png", alt: "Select mesh for emission") {...from a mesh instance as the source}

@Image(source: "particle_emission_density.png", alt: "Set emission density") {More points = higher particle density}
