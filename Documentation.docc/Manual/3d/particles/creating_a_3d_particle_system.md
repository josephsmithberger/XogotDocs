...
[ParticleProcessMaterial](https://docs.godotengine.org/en/stable/classes/class_particleprocessmaterial.html#class-particleprocessmaterial) is a special kind of material. We don't use it to draw any objects.
...
@Image(source: "particle_two_draw_passes.png") {Using multiple draw passes: yellow rectangles (pass1) and blue spheres (pass 2)}
...
particle effects. Take a look at the documentation for <doc:index#Properties> and
<doc:process_material_properties> properties to
learn how to make particle effects more interesting.

@Image(source: "particle_basic_system.png")

## Particle conversion

@Image(source: "particle_convert_cpu.png") {Turning GPU into CPU particles}
