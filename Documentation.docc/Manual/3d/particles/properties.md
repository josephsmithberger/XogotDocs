...
@Image(source: "particle_props_emitter.png")
...
particle. See the <doc:index#Subemitters> section in this manual for a detailed explanation of how
to add a sub-emitter to a particle system.

## Time properties

@Image(source: "particle_props_time.png")
...
@Image(source: "particle_preprocess.png") {No preprocess (left) vs. 4 seconds of preprocess (right)}
...
@Image(source: "particle_speed_scale.png") {Different speed scale values: 0.1 (left), 0.5 (middle), 1.0 (right)}
...
@Image(source: "particle_interpolate.png", alt: "Particles running at low FPS") {Interpolation off (left) vs. on (right)}
...
> Note:
>
> When using <doc:index#Collision>, tunneling can occur
...
@Image(source: "particle_drawing.png", alt: "Particle drawing properties")
...
@Image(source: "particle_coords.png") {Local space coordinates (left) vs. world space coordinates (right)}
...
similar to the `Billboard` property in the <doc:standard_material_3d>.
...
@Image(source: "particle_trail.png", alt: "Particle trails") {Particle trail properties}
...
See the <doc:index#Trails> section in this manual for a detailed
