...
@Image(source: "particle_turbulence.png", alt: "Particle turbulence")

Turbulence uses a noise texture to add variation and interesting patterns to particle movement.
It can be combined with <doc:index#Attractors> and
<doc:index#Collision> nodes to create even more complex looking behavior.

@Image(source: "particle_turbulence_properties.png", alt: "Turbulence properties") {Particle turbulence properties}
...
to follow a more complex movement path. Second, you need to <doc:process_material_properties_turbulence>.
...
@Image(source: "particle_turbulence_influence.png", alt: "Turbulence influence") {Notice how the particle paths are more narrow and less spread out at high influence values (right)}
...
@Image(source: "particle_turbulence_displacement.png", alt: "Turbulence displacement") {No displacement (left), displacement value of 5 (middle), displacement range [-20, 20] (right)}