...
@Image(source: "gi_none.png", alt: "VoxelGI disabled.") {VoxelGI disabled.}

@Image(source: "gi_voxel_gi.png", alt: "VoxelGI enabled.") {VoxelGI enabled.}
...
1. Create a VoxelGI node in the Scene tree dock.

1. Move the VoxelGI node to the center of the area you want it to cover by
...
1. Select the VoxelGI node and click **Bake** at the top of the 3D editor viewport.
...
> Seealso:
>
> See <doc:introduction_to_global_illumination#Gi-Mode-Recommendations>
