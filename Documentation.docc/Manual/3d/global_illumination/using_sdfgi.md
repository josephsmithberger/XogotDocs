...
<doc:using_lightmap_gi>, but worse real-time ability than
<doc:using_voxel_gi>.
...
@Image(source: "gi_none.png", alt: "SDFGI disabled.") {SDFGI disabled.}

@Image(source: "gi_sdfgi.png", alt: "SDFGI enabled.") {SDFGI enabled.}
...
1. Edit the Environment resource, scroll down to the **SDFGI** section and unfold it.

1. Enable **SDFGI > Enabled**. SDFGI will automatically follow the camera when it
