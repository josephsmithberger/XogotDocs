...
lighting to a scene. Unlike the <doc:using_voxel_gi> and
<doc:using_sdfgi> approaches, baked lightmaps work fine on low-end PCs
...
<doc:standard_material_3d> or in custom shaders).
...
> See <doc:introduction_to_global_illumination#Comparison>
> for a comparison of GI techniques available in Godot 4.
>

## Visual comparison

@Image(source: "gi_none.png", alt: "LightmapGI disabled.") {LightmapGI disabled.}

@Image(source: "gi_lightmap_gi_indirect_only.png", alt: "LightmapGI enabled (with indirect light baked only).") {LightmapGI enabled (with indirect light baked only). Direct light is still
real-time, allowing for subtle changes during gameplay.}

@Image(source: "gi_lightmap_gi_direct_and_indirect.png", alt: "LightmapGI enabled (with direct and indirect light baked).") {LightmapGI enabled (with direct and indirect light baked). Best performance,
...
@Image(source: "lightmap_gi_comparison.png")
...
@Image(source: "lightmap_gi_mesh_menu.png")
...
> Note:
>
> This option is only available for primitive meshes such as [BoxMesh](https://docs.godotengine.org/en/stable/classes/class_boxmesh.html#class-boxmesh),
> [CylinderMesh](https://docs.godotengine.org/en/stable/classes/class_cylindermesh.html#class-cylindermesh), [PlaneMesh](https://docs.godotengine.org/en/stable/classes/class_planemesh.html#class-planemesh), etc.
>
...
<doc:csg_tools#Converting-To-Mesh-Instance-3d>.
...
@Image(source: "lightmap_gi_uvchannel.png")
...
@Image(source: "lightmap_gi_scene.png")
...
@Image(source: "lightmap_gi_use.png")
...
@Image(source: "lightmap_gi_bake_mode.png")
...
@Image(source: "lightmap_gi_omnilight_size.png")
...
@Image(source: "lightmap_gi_bake.png")
...
from the camera. See the <doc:using_lightmap_gi#Shadowmask>
for further details.
...
<doc:using_lightmap_gi#Denoising> for more information.
...
- **Gen Probes > Subdiv:** See <doc:using_lightmap_gi#Dynamic-Objects>.

- **Data > Light Data:** See <doc:using_lightmap_gi#Data>.
...
@Image(source: "lightmap_gi_shadowmask.png", alt: "Comparison between shadowmask modes") {Comparison between shadowmask modes}
...
@Image(source: "lightmap_gi_denoiser_comparison.png", alt: "Comparison between denoising disabled and enabled") {Comparison between denoising disabled and enabled (with the default JNLM denoiser).}
...
@Image(source: "lightmap_gi_denoiser_jnlm_strength.png", alt: "Comparison between JNLM denoiser strength values") {Comparison between JNLM denoiser strength values. Higher values can reduce detail.}
...
@Image(source: "lightmap_gi_denoiser_jnlm_vs_oidn.png", alt: "Comparison between JNLM and OIDN denoisers") {Comparison between JNLM and OIDN denoisers.
...
automatically, you can add light probes manually by adding [LightmapProbe](https://docs.godotengine.org/en/stable/classes/class_lightmapprobe.html#class-lightmapprobe)
