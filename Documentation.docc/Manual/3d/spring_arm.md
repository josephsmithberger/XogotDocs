...
In Godot, this can be done by setting a [Camera3D](https://docs.godotengine.org/en/stable/classes/class_camera3d.html#class-camera3d) as a child of a node.
...
@Image(source: "spring_arm_position_length.png")
...
@Image(source: "spring_arm_shape.png")
...
@Image(source: "spring_arm_children.png")
...
@Image(source: "spring_arm_camera_shape.png")
