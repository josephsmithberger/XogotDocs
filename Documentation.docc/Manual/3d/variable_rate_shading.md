...
<doc:3d_antialiasing> technique (MSAA, FXAA, TAA, SSAA).
...
@Image(source: "variable_rate_shading_textured_disabled.png", alt: "Variable rate shading disabled in textured scene") {Variable rate shading disabled in textured scene}

@Image(source: "variable_rate_shading_textured_enabled.png", alt: "Variable rate shading enabled in textured scene (lower quality, but higher performance)") {Variable rate shading enabled in textured scene (lower quality, but higher performance)}
...
@Image(source: "variable_rate_shading_untextured_disabled.png", alt: "Variable rate shading disabled in untextured scene") {Variable rate shading disabled in untextured scene}

@Image(source: "variable_rate_shading_untextured_enabled.png", alt: "Variable rate shading enabled in untextured scene (lower quality, but higher performance)") {Variable rate shading enabled in untextured scene (lower quality, but higher performance)}
...
> For XR, you can use <doc:openxr_settings#Foveation-Level>
> as an alternative.
>
...
[Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport) node.
...
@Image(source: "variable_rate_shading_texture_example.png", alt: "Example VRS density map texture, simulating foveated rendering") {Example VRS density map texture, simulating foveated rendering}
...
> <doc:resolution_scaling#Mipmap-Bias>
