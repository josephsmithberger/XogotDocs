...
- Ambient light in the [Environment](https://docs.godotengine.org/en/stable/classes/class_environment.html#class-environment) or
<doc:reflection_probes>.

- Global illumination (<doc:using_lightmap_gi>,
<doc:using_voxel_gi> or <doc:using_sdfgi>).

The emission color is a material property. You can read more about it
in the <doc:standard_material_3d> tutorial.

> Seealso:
>
> You can compare various types of lights in action using the
> 3D Lights and Shadows demo project.
>

## Light nodes

There are three types of light nodes: [DirectionalLight3D](https://docs.godotengine.org/en/stable/classes/class_directionallight3d.html#class-directionallight3d),
[OmniLight3D](https://docs.godotengine.org/en/stable/classes/class_omnilight3d.html#class-omnilight3d) and [SpotLight3D](https://docs.godotengine.org/en/stable/classes/class_spotlight3d.html#class-spotlight3d). Let's take a look at the common
parameters for lights:

@Image(source: "light_params.png")
...
- **Indirect Energy:** Secondary multiplier used with indirect light (light bounces). This works with <doc:using_lightmap_gi>, VoxelGI or SDFGI.
...
- **Bake Mode:** Sets the bake mode for the light. See <doc:using_lightmap_gi>.
...
> Seealso:
>
> See <doc:physical_light_and_camera_units> if you wish to use real world
...
consider using <doc:using_lightmap_gi> with lights' bake
...
<doc:introduction_to_global_illumination> technique
...
See also <doc:lights_and_shadows#Shadow-Filter-Mode>.
...
@Image(source: "lights_and_shadows_blur.png")
...
@Image(source: "lights_and_shadows_acne.png")
...
@Image(source: "lights_and_shadows_peter_panning.png")
...
<doc:lights_and_shadows#Balancing-Performance-And-Quality>,
...
@Image(source: "light_directional.png")
...
@Image(source: "lights_and_shadows_pssm_explained.png")

With this, shadows become more detailed:

@Image(source: "lights_and_shadows_directional_mode.png")
...
@Image(source: "lights_and_shadows_dual_parabolid_vs_cubemap.png")
...
to [PanoramaSkyMaterial](https://docs.godotengine.org/en/stable/classes/class_panoramaskymaterial.html#class-panoramaskymaterial) textures.

With the projector texture below, the following result is obtained:

@Image(source: "lights_and_shadows_omni_projector_example.png")

@Image(source: "lights_and_shadows_omni_projector.png")

> Tip:
>
> If you've acquired omni projectors in the form of cubemap images, you can use
> this web-based conversion tool
...
@Image(source: "lights_and_shadows_spot_projector_example.png")

@Image(source: "lights_and_shadows_spot_projector.png")
...
1. Check if any object affecting the shadow map has changed. If it did, re-render the light.

1. If neither of the above has happened, nothing is done, and the shadow is left untouched.
...
1. The second quadrant can store 4 other shadows.

1. The third quadrant can store 16 shadows, with less detail.

1. The fourth and least detailed quadrant can store 64 shadows, with even less detail.
...
appropriate [RenderingServer](https://docs.godotengine.org/en/stable/classes/class_renderingserver.html#class-renderingserver) methods.

Positional (omni/spot) shadow quality settings can be changed at runtime on the
root [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport).
...
<doc:lights_and_shadows#Shadow-Atlas> quadrants to contain
...
<doc:3d_antialiasing#Taa>, <doc:3d_antialiasing#Fsr2>,
<doc:3d_antialiasing#Fxaa>, or increase the shadow filter quality to
...
@Image(source: "lights_and_shadows_filter_quality.png")
