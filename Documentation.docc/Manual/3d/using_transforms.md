...
@Image(source: "transforms_gimbal.gif")
...
@Image(source: "transforms_interpolate1.gif")

But this does not always have the expected effect when using angles:

@Image(source: "transforms_interpolate2.gif")
...
For more information on the mathematics of vectors and transforms, please read the <doc:vector_math> tutorials.
