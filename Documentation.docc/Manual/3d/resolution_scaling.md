...
- **FSR 1.0:** AMD FidelityFX Super Resolution 1.0.
...
@Image(source: "resolution_scaling_bilinear_0.5.png")

@Image(source: "resolution_scaling_fsr1_0.5.png")

@Image(source: "resolution_scaling_fsr2_0.5.png")
...
@Image(source: "resolution_scaling_bilinear_msaa_4x_0.5.png")

@Image(source: "resolution_scaling_fsr1_msaa_4x_0.5.png")

@Image(source: "resolution_scaling_fsr2_msaa_4x_0.5.png")
...
See the <doc:index> tutorials for more information.