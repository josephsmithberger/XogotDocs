...
[EditorImportPlugin class](https://docs.godotengine.org/en/stable/classes/class_editorimportplugin.html#class-editorimportplugin). It is responsible for
...
In our case it's a [StandardMaterial3D](https://docs.godotengine.org/en/stable/classes/class_standardmaterial3d.html#class-standardmaterial3d), which can be applied to 3D
objects.
...
@Image(source: "import_plugin_options.png")
...
hint_string | String | The hint text of the property. The same as you'd add in theexportstatement in GDScript.
...
[FileAccess](https://docs.godotengine.org/en/stable/classes/class_fileaccess.html#class-fileaccess) class to do that, passing the source_file
...
Then it creates a new [Color](https://docs.godotengine.org/en/stable/classes/class_color.html#class-color) variable and sets its values
...
This part makes a new [StandardMaterial3D](https://docs.godotengine.org/en/stable/classes/class_standardmaterial3d.html#class-standardmaterial3d) that is the
...
extension, so we add it using <doc:gdscript_format_string>. For
...
variants, it is based on the presence of <doc:feature_tags>,
...
@Image(source: "import_plugin_trying.png")
