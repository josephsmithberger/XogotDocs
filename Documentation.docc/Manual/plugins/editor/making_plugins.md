...
@Image(source: "making_plugins-create_plugin_dialog.png")
...
> <doc:index#Basics-Class-Name>. If you
...
@Image(source: "making_plugins-custom_node_create.png")
...
@Image(source: "making_plugins-custom_node_console.png")
...
For an editor dock, the root node **must** be a [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control)
...
@Image(source: "making_plugins-project_settings.png")
...
@Image(source: "making_plugins-custom_dock.png")

## Registering autoloads/singletons in plugins

It is possible for editor plugins to automatically register
<doc:singletons_autoload> when the plugin is enabled.
...
@Image(source: "sub_plugin_creation.png")

Then move the sub plugins into the main plugin folder:

@Image(source: "sub_plugin_moved.png")
