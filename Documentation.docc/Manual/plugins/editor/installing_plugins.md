...
@Image(source: "installing_plugins_assetlib_tab.png")
...
@Image(source: "installing_plugins_github_download_zip.png")
...
@Image(source: "installing_plugins_project_settings.png")
