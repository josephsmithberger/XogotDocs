...
to play the game (given their hardware). For mobile, Google has useful stats online, and for desktop,
Steam also does.
...
> Multiple Resolutions and Aspect Ratios demo project.
>
...
little easier. The [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport)
...
@Image(source: "stretchsettings.png")
...
and a diagonal [Line2D](https://docs.godotengine.org/en/stable/classes/class_line2d.html#class-line2d) is added on top of it:

@Image(source: "stretch_demo_scene.png")
...
@Image(source: "stretch_disabled_expand.gif")
...
@Image(source: "stretch_2d_expand.gif")

- **Stretch Mode = Viewport**: Viewport scaling means that the size of
the root [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport) is set precisely to the
...
@Image(source: "stretch_viewport_ignore.gif")
...
@Image(source: "stretch_viewport_keep.gif")
...
@Image(source: "stretch_viewport_keep_width.gif")
...
@Image(source: "stretch_viewport_keep_height.gif")
...
To resolve this, you can <doc:importing_images#Mipmaps> on
...
done using <doc:size_and_anchors> and/or <doc:gui_containers>.
