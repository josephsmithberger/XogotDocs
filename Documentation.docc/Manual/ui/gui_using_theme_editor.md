...
a [Theme](https://docs.godotengine.org/en/stable/classes/class_theme.html#class-theme) resource is selected for editing. It contains
...
Same applies to the contents of complex resource types, such as [StyleBoxes](https://docs.godotengine.org/en/stable/classes/class_stylebox.html#class-stylebox)
and icons — they open for editing in the Inspector.

@Image(source: "default_font.png")

## Theme editor overview

@Image(source: "theme_editor.png")
...
@Image(source: "default_preview.png")
...
@Image(source: "scene_preview.png")
...
@Image(source: "theme_preview_picker.png")
...
@Image(source: "theme_type_editor.png")
...
@Image(source: "theme_item_inspector.png")
...
@Image(source: "theme_pin_the_stylebox.png")
