...
<doc:size_and_anchors> are an efficient way to handle
...
For that, [Containers](https://docs.godotengine.org/en/stable/classes/class_container.html#class-container) are more useful.
...
@Image(source: "godot_containers.png")

When a [Container](https://docs.godotengine.org/en/stable/classes/class_container.html#class-container)-derived node is used, all children [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control) nodes give up their
...
@Image(source: "container_example.gif")
...
@Image(source: "container_sizing_options.png")
...
Arranges child controls vertically or horizontally (via [HBoxContainer](https://docs.godotengine.org/en/stable/classes/class_hboxcontainer.html#class-hboxcontainer) and
[VBoxContainer](https://docs.godotengine.org/en/stable/classes/class_vboxcontainer.html#class-vboxcontainer)). In the opposite of the designated direction
(as in, vertical for a horizontal container), it just expands the children.

@Image(source: "containers_box.png")

These containers make use of the Stretch Ratio property for children with the Expand flag set.

### Grid Container

Arranges child controls in a grid layout (via [GridContainer](https://docs.godotengine.org/en/stable/classes/class_gridcontainer.html#class-gridcontainer), amount
of columns must be specified). Uses both the vertical and horizontal expand flags.

@Image(source: "containers_grid.png")

### Margin Container

Child controls are expanded towards the bounds of this control (via
[MarginContainer](https://docs.godotengine.org/en/stable/classes/class_margincontainer.html#class-margincontainer)). Padding will be added on the margins
depending on the theme configuration.

@Image(source: "containers_margin.png")
...
@Image(source: "containers_margin_constants.png")

### Tab Container

Allows you to place several child controls stacked on top of each other (via
[TabContainer](https://docs.godotengine.org/en/stable/classes/class_tabcontainer.html#class-tabcontainer)), with only the current one visible.

@Image(source: "containers_tab.png")

Changing the current one is done via tabs located at the top of the container, via clicking:

@Image(source: "containers_tab_click.gif")
...
(via [HSplitContainer](https://docs.godotengine.org/en/stable/classes/class_hsplitcontainer.html#class-hsplitcontainer) and [VSplitContainer](https://docs.godotengine.org/en/stable/classes/class_vsplitcontainer.html#class-vsplitcontainer)).
Respects both horizontal and vertical flags, as well as Ratio.

@Image(source: "containers_split.png")

The divisor can be dragged around to change the size relation between both children:

@Image(source: "containers_split_drag.gif")

### PanelContainer

A container that draws a StyleBox, then expands children to cover its whole area
(via [PanelContainer](https://docs.godotengine.org/en/stable/classes/class_panelcontainer.html#class-panelcontainer), respecting the StyleBox margins).
...
(via [AspectRatioContainer](https://docs.godotengine.org/en/stable/classes/class_aspectratiocontainer.html#class-aspectratiocontainer)).
...
it as if it was an image (via [SubViewportContainer](https://docs.godotengine.org/en/stable/classes/class_subviewportcontainer.html#class-subviewportcontainer)).
