...
When designing a user interface there may be times when a [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control) node
needs to have a different look than what is normally defined by a [Theme](https://docs.godotengine.org/en/stable/classes/class_theme.html#class-theme).
...
between several controls. Imagine that you use gray, blue, and red variants of [Button](https://docs.godotengine.org/en/stable/classes/class_button.html#class-button)
throughout your project. Setting it up every time you add a new button element to your interface
is a tedious task.

To help with the organization and to better utilize the <doc:gui_skinning>
...
> theme is better described in the <doc:gui_theme_in_project>
