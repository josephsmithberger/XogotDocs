...
[Label](https://docs.godotengine.org/en/stable/classes/class_label.html#class-label) nodes are great for displaying basic text, but they have limitations.
...
of the text centered. To get around these limitations, you would use a [RichTextLabel](https://docs.godotengine.org/en/stable/classes/class_richtextlabel.html#class-richtextlabel).

[RichTextLabel](https://docs.godotengine.org/en/stable/classes/class_richtextlabel.html#class-richtextlabel) allows for complex formatting of text using a markup syntax or
...
- BBCode can be used to <doc:index#Bbcode>.

- BBCode can be used in <doc:gdscript_documentation_comments#Bbcode-And-Class-Reference>.

- BBCode can be used when <doc:output_panel#Printing-Rich-Text>.

> Seealso:
>
> You can see how BBCode in RichTextLabel works in action using the
> Rich Text Label with BBCode demo project.
>
...
@Image(source: "bbcode_in_richtextlabel_escaping_user_input.png", alt: "Example of unescaped user input resulting in BBCode injection (2nd line) and escaped user input (3rd line)") {Example of unescaped user input resulting in BBCode injection (2nd line) and escaped user input (3rd line)}
...
> message was removed.
> <doc:bbcode_in_richtextlabel#Handling-User-Input-Safely>
...
Justification (fill alignment) option. See [TextServer](https://docs.godotengine.org/en/stable/classes/class_textserver.html#class-textserver) for more details.
...
`Values`
ISO language codes. See <doc:locales>
...
@Image(source: "bbcode_in_richtextlabel_image_align.png")
...
@Image(source: "color_constants.png")
...
<doc:pausing_games>. You can change this
...
@Image(source: "bbcode_in_richtextlabel_effect_pulse.png")
