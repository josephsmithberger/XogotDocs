...
@Image(source: "focus_settings.png")
...
example, [Label](https://docs.godotengine.org/en/stable/classes/class_label.html#class-label) nodes are set to "None" by default,
while [buttons](https://docs.godotengine.org/en/stable/classes/class_button.html#class-button) are set to "All".
