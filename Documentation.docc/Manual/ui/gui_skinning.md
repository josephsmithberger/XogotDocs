...
pleasing user interface to its players. While [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control)
...
@Image(source: "tank-kings-by-winterpixel-games.png") {A "Gear Up!" screen in Tank Kings, courtesy of Winterpixel Games}
...
The skinning system is driven by the [Theme](https://docs.godotengine.org/en/stable/classes/class_theme.html#class-theme) resource. Every
...
> as explained <doc:gui_theme_in_project>.
>
...
- **Color**
A [color](https://docs.godotengine.org/en/stable/classes/class_color.html#class-color) value, which is often used for fonts
...
controls (such as the item separation in a [BoxContainer](https://docs.godotengine.org/en/stable/classes/class_boxcontainer.html#class-boxcontainer)),
or for boolean flags (such as the drawing of relationship lines in a [Tree](https://docs.godotengine.org/en/stable/classes/class_tree.html#class-tree)).


- **Font**
A [font](https://docs.godotengine.org/en/stable/classes/class_font.html#class-font) resource, which is used by controls that
...
- **Icon**
A [texture](https://docs.godotengine.org/en/stable/classes/class_texture2d.html#class-texture2d) resource, which is normally used
to display an icon (on a [Button](https://docs.godotengine.org/en/stable/classes/class_button.html#class-button), for example).


- **StyleBox**
A [StyleBox](https://docs.godotengine.org/en/stable/classes/class_stylebox.html#class-stylebox) resource, a collection of configuration
...
essential. Nodes such as [BoxContainer](https://docs.godotengine.org/en/stable/classes/class_boxcontainer.html#class-boxcontainer) and
[GridContainer](https://docs.godotengine.org/en/stable/classes/class_gridcontainer.html#class-gridcontainer) use theme constants for defining
separation between their children, and [MarginContainer](https://docs.godotengine.org/en/stable/classes/class_margincontainer.html#class-margincontainer)
...
1. Using control's type variation, class name and parent class names:
...
1. If it does, check that theme for the matching item of the same name, data and theme type;

1. If there is no custom theme or it doesn't have the item, move to the parent control;

1. Repeat steps a-c. until the root of the tree is reached, or a non-control node is reached.

1. Using control's type variation, class name and parent class names check the project-wide theme, if it's present.

1. Using control's type variation, class name and parent class names check the default theme.
