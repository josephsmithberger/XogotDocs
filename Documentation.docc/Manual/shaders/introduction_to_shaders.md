...
> more information see <doc:compute_shaders>.
>
...
- <doc:spatial_shader> for 3D rendering.

- <doc:canvas_item_shader> for 2D rendering.

- <doc:particle_shader> for particle systems.

- <doc:sky_shader> to render [Skies](https://docs.godotengine.org/en/stable/classes/class_sky.html#class-sky).

- <doc:fog_shader> to render [FogVolumes](https://docs.godotengine.org/en/stable/classes/class_fogvolume.html#class-fogvolume)
...
data yourself; see the <doc:spatial_shader> for an
example.
