...
> Note:
>
> The shader preprocessor is not available in <doc:visual_shaders>.
...
menu option of the shader editor, or by creating a new [ShaderInclude](https://docs.godotengine.org/en/stable/classes/class_shaderinclude.html#class-shaderinclude) resource
