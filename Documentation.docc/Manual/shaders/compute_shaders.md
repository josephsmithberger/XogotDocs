...
> to shaders please read <doc:introduction_to_shaders> and :ref:`your
...
1. The code is using GLSL version 450.
...
1. Begin a list of instructions for our GPU to execute.

1. Bind our compute list to our pipeline

1. Bind our buffer uniform to our pipeline

1. Specify how many workgroups to use
