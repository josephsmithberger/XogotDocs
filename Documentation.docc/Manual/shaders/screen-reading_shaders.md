...
@Image(source: "texscreen_demo1.png")
...
In 2D, this can be corrected via the [BackBufferCopy](https://docs.godotengine.org/en/stable/classes/class_backbuffercopy.html#class-backbuffercopy)
...
@Image(source: "texscreen_bbc.png")

With correct back-buffer copying, the two spheres blend correctly:

@Image(source: "texscreen_demo2.png")
...
You can reproduce the back-buffer logic in 3D by creating a [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport)
with a camera in the same position as your object, and then use the
[Viewport's](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport) texture instead of the screen texture.
