...
[StandardMaterial3D](https://docs.godotengine.org/en/stable/classes/class_standardmaterial3d.html#class-standardmaterial3d) isn't quite meeting your
needs. Either way, you have decided to write your own and now you need to figure
out where to start.

This tutorial will explain how to write a Spatial shader and will cover more
topics than the <doc:your_first_2d_shader> tutorial.
...
vertex function. In the <doc:your_second_3d_shader> we
...
In 3D, objects are drawn using [Meshes](https://docs.godotengine.org/en/stable/classes/class_mesh.html#class-mesh). Meshes are a resource
...
program (e.g. Blender). But Godot also has a few [PrimitiveMeshes](https://docs.godotengine.org/en/stable/classes/class_primitivemesh.html#class-primitivemesh) that allow you to add basic geometry to a scene without
importing Meshes.

There are multiple node types that you can use to draw a mesh. The main one is
[MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d), but you can also use [GPUParticles3D](https://docs.godotengine.org/en/stable/classes/class_gpuparticles3d.html#class-gpuparticles3d), [MultiMeshes](https://docs.godotengine.org/en/stable/classes/class_multimesh.html#class-multimesh) (with a
[MultiMeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_multimeshinstance3d.html#class-multimeshinstance3d)), or others.
...
[MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d). This will give us more vertices to work with
and thus allow us to add more detail.

@Image(source: "plane-sub.png")
...
> Note:
> Materials that inherit from the [Material](https://docs.godotengine.org/en/stable/classes/class_material.html#class-material) resource, such as [StandardMaterial3D](https://docs.godotengine.org/en/stable/classes/class_standardmaterial3d.html#class-standardmaterial3d)
> and [ParticleProcessMaterial](https://docs.godotengine.org/en/stable/classes/class_particleprocessmaterial.html#class-particleprocessmaterial), can be converted to a [ShaderMaterial](https://docs.godotengine.org/en/stable/classes/class_shadermaterial.html#class-shadermaterial)
...
Godot provides the [NoiseTexture2D](https://docs.godotengine.org/en/stable/classes/class_noisetexture2d.html#class-noisetexture2d) resource for
...
Set this **Noise** parameter to a new [NoiseTexture2D](https://docs.godotengine.org/en/stable/classes/class_noisetexture2d.html#class-noisetexture2d).
Then in your NoiseTexture2D, set its **Noise** property to a new
[FastNoiseLite](https://docs.godotengine.org/en/stable/classes/class_fastnoiselite.html#class-fastnoiselite). The FastNoiseLite class is used by
...
<doc:shading_language#Uniforms> allow you to pass data
...
@Image(source: "noise-low.png")

Using uniforms, we can even change the value every frame to animate the height
of the terrain. Combined with [Tweens](https://docs.godotengine.org/en/stable/classes/class_tween.html#class-tween), this can be
...
First, we will add an [OmniLight3D](https://docs.godotengine.org/en/stable/classes/class_omnilight3d.html#class-omnilight3d) to the scene, and
...
the light shader uses the normals from the [Mesh](https://docs.godotengine.org/en/stable/classes/class_mesh.html#class-mesh) to calculate
light.
...
Set this second uniform texture to another [NoiseTexture2D](https://docs.godotengine.org/en/stable/classes/class_noisetexture2d.html#class-noisetexture2d) with another
[FastNoiseLite](https://docs.godotengine.org/en/stable/classes/class_fastnoiselite.html#class-fastnoiselite). But this time, check **As Normal Map**.
...
@Image(source: "normalmap.png")

We can even drag the light around and the lighting will update automatically.

@Image(source: "normalmap2.png")
