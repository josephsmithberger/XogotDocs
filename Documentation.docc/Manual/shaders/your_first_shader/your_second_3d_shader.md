...
For a full list of render modes see the <doc:spatial_shader>.
...
@Image(source: "specular-toon.png")
...
@Image(source: "wave3.png")

For more information about Spatial shaders read the <doc:shading_language> doc and the <doc:spatial_shader>
