...
DOF, and SSAO, which are described in <doc:environment_and_post_processing>.
...
<doc:screen-reading_shaders> first.
...
For this demo, we will use this [Sprite](https://docs.godotengine.org/en/stable/classes/class_sprite2d.html#class-sprite2d) of a sheep.
...
@Image(source: "post_example2.png")
...
@Image(source: "post_example3.png")