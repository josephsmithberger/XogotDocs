...
<doc:importing_translations> tutorial. If you haven't read the Importing
...
@Image(source: "localization_dialog.png")
...
@Image(source: "localization_remaps.png")
...
>
> A good resource for multilingual fonts is Noto Fonts.
...
this, make sure to read the tutorial on <doc:size_and_anchors>, as
dynamically adjusting control sizes may help.
[Container](https://docs.godotengine.org/en/stable/classes/class_container.html#class-container) can be useful, as well as the text wrapping
...
called the [TranslationServer](https://docs.godotengine.org/en/stable/classes/class_translationserver.html#class-translationserver).
...
@Image(source: "bidi_override.png")
...
@Image(source: "localized_name.png")
