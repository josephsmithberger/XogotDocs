...
found here on GitHub and in Godot's asset
library.
...
[ConcavePolygonShape3D](https://docs.godotengine.org/en/stable/classes/class_concavepolygonshape3d.html#class-concavepolygonshape3d) or [HeightMapShape3D](https://docs.godotengine.org/en/stable/classes/class_heightmapshape3d.html#class-heightmapshape3d) as either "active" or "inactive", based on
...
[ConcavePolygonShape3D](https://docs.godotengine.org/en/stable/classes/class_concavepolygonshape3d.html#class-concavepolygonshape3d) and [HeightMapShape3D](https://docs.godotengine.org/en/stable/classes/class_heightmapshape3d.html#class-heightmapshape3d), but also edges between any shapes within
the same body.
...
[WorldBoundaryShape3D](https://docs.godotengine.org/en/stable/classes/class_worldboundaryshape3d.html#class-worldboundaryshape3d), which is meant to represent an infinite plane, is
