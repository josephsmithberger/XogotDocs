...
- A [PhysicalBoneSimulator3D](https://docs.godotengine.org/en/stable/classes/class_physicalbonesimulator3d.html#class-physicalbonesimulator3d) node.
This node is the parent of all physical bones and is responsible
for controlling the simulation.

- One or more [PhysicalBone3D](https://docs.godotengine.org/en/stable/classes/class_physicalbone3d.html#class-physicalbone3d) children.
...
@Image(source: "ragdoll_system_create_physical_skeleton.png", alt: "Creating a physical skeleton in the editor") {Creating a physical skeleton in the editor}
...
@Image(source: "ragdoll_system_skeleton_scene_tree.png", alt: "Scene tree of the player scene after creating a physical skeleton") {Scene tree of the player scene after creating a physical skeleton}
...
@Image(source: "ragdoll_system_adjust_joints_inspector.png", alt: "Adjusting joints in the inspector after selecting a PhysicalBone3D node") {Adjusting joints in the inspector after selecting a PhysicalBone3D node}
...
@Image(source: "ragdoll_system_adjust_collision_shapes.png", alt: "Adjusting collision shapes in the 3D editor") {Adjusting collision shapes in the 3D editor}

This is the final result:

@Image(source: "ragdoll_system_result.png", alt: "Result after adjusting joints and collision shapes (player mesh is hidden for visibility)") {Result after adjusting joints and collision shapes (player mesh is hidden for visibility)}
...
> [PhysicalBoneSimulator3D](https://docs.godotengine.org/en/stable/classes/class_physicalbonesimulator3d.html#class-physicalbonesimulator3d) node that is the
...
@Image(source: "ragdoll_system_collision_layers_masks.png", alt: "Layers and masks must be adjusted to these values in the inspector for each node") {Layers and masks must be adjusted to these values in the inspector for each node}
...
> Seealso:
>
> For more information, see <doc:physics_introduction#Collision-Layers-And-Masks>.