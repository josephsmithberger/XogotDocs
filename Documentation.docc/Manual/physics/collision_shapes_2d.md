...
You can define the shape of a [PhysicsBody2D](https://docs.godotengine.org/en/stable/classes/class_physicsbody2d.html#class-physicsbody2d) by adding one or more
[CollisionShape2Ds](https://docs.godotengine.org/en/stable/classes/class_collisionshape2d.html#class-collisionshape2d) or
[CollisionPolygon2Ds](https://docs.godotengine.org/en/stable/classes/class_collisionpolygon2d.html#class-collisionpolygon2d) as direct child nodes.
Indirect child nodes (i.e. children of child nodes) will be ignored and won't be
used as collision shapes. Also, note that you must add a [Shape2D](https://docs.godotengine.org/en/stable/classes/class_shape2d.html#class-shape2d)
...
- [SeparationRayShape2D](https://docs.godotengine.org/en/stable/classes/class_separationrayshape2d.html#class-separationrayshape2d) (designed for characters)

- [WorldBoundaryShape2D](https://docs.godotengine.org/en/stable/classes/class_worldboundaryshape2d.html#class-worldboundaryshape2d) (infinite plane)
...
[Convex collision shapes](https://docs.godotengine.org/en/stable/classes/class_convexpolygonshape2d.html#class-convexpolygonshape2d) are a compromise
...
[Concave collision shapes](https://docs.godotengine.org/en/stable/classes/class_concavepolygonshape2d.html#class-concavepolygonshape2d), also called trimesh
