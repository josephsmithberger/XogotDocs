...
@Image(source: "softbody_cube.png")
...
@Image(source: "softbody_cube_menu.png")
...
> Note: You can download the Platformer3D demo on GitHub or the Asset Library.
>
...
@Image(source: "softbody_cloak_subdivide.png")

> Tip: Subdivision generates a more tessellated mesh for better simulations.
>

Add a [BoneAttachment3D](https://docs.godotengine.org/en/stable/classes/class_boneattachment3d.html#class-boneattachment3d) node under the skeleton node and select the Neck bone to attach the cloak to the character skeleton.
...
@Image(source: "softbody_cloak_bone_attach.png")

To create pinned joints, select the upper vertices in the SoftBody node:

@Image(source: "softbody_cloak_pinned.png")
