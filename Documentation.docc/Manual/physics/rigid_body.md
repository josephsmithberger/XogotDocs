...
In order to define the shape of the body, it must have one or more [Shape3D](https://docs.godotengine.org/en/stable/classes/class_shape3d.html#class-shape3d) objects assigned. Note that setting the position of these shapes will affect the body's center of mass.
...
See [RigidBody3D](https://docs.godotengine.org/en/stable/classes/class_rigidbody3d.html#class-rigidbody3d) and [PhysicsMaterial](https://docs.godotengine.org/en/stable/classes/class_physicsmaterial.html#class-physicsmaterial) for
