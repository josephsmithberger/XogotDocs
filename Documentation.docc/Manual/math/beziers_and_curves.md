...
They rely on <doc:interpolation>, which we saw in the
...
@Image(source: "bezier_quadratic_points.png")
...
@Image(source: "bezier_quadratic_points2.gif")
...
@Image(source: "bezier_cubic_points.png")
...
@Image(source: "bezier_cubic_points.gif")
...
@Image(source: "bezier_cubic_handles.png")
...
There are two objects that contain curves: [Curve3D](https://docs.godotengine.org/en/stable/classes/class_curve3d.html#class-curve3d) and [Curve2D](https://docs.godotengine.org/en/stable/classes/class_curve2d.html#class-curve2d) (for 3D and 2D respectively).

They can contain several points, allowing for longer paths. It is also possible to set them to nodes: [Path3D](https://docs.godotengine.org/en/stable/classes/class_path3d.html#class-path3d) and [Path2D](https://docs.godotengine.org/en/stable/classes/class_path2d.html#class-path2d) (also for 3D and 2D respectively):

@Image(source: "bezier_path_2d.png")
...
@Image(source: "bezier_interpolation_speed.gif")
...
@Image(source: "bezier_point_amount.png")
...
@Image(source: "bezier_interpolation_baked.gif")