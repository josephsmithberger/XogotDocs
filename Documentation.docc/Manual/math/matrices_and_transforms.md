...
Most of this guide focuses on 2D, using [Transform2D](https://docs.godotengine.org/en/stable/classes/class_transform2d.html#class-transform2d) and
[Vector2](https://docs.godotengine.org/en/stable/classes/class_vector2.html#class-vector2), but the way things work in 3D is very similar.
...
@Image(source: "identity-godot.png")
...
Note that in 3D, Godot has a separate [Basis](https://docs.godotengine.org/en/stable/classes/class_basis.html#class-basis) structure
for holding the three [Vector3](https://docs.godotengine.org/en/stable/classes/class_vector3.html#class-vector3) values of the basis,
since the code can get complex and it makes sense to separate
it from [Transform3D](https://docs.godotengine.org/en/stable/classes/class_transform3d.html#class-transform3d) (which is composed of one
[Basis](https://docs.godotengine.org/en/stable/classes/class_basis.html#class-basis) and one extra [Vector3](https://docs.godotengine.org/en/stable/classes/class_vector3.html#class-vector3) for the origin).
...
matrix has four total numbers in two [Vector2](https://docs.godotengine.org/en/stable/classes/class_vector2.html#class-vector2) values, while
...
@Image(source: "identity-grid.png")
...
transforms by having multiple [Node2D](https://docs.godotengine.org/en/stable/classes/class_node2d.html#class-node2d) or [Node3D](https://docs.godotengine.org/en/stable/classes/class_node3d.html#class-node3d)
nodes parented to each other.

However, it's useful to understand how to manually calculate the values we
need. We will go over how you could use [Transform2D](https://docs.godotengine.org/en/stable/classes/class_transform2d.html#class-transform2d) or
[Transform3D](https://docs.godotengine.org/en/stable/classes/class_transform3d.html#class-transform3d) to manually calculate transforms of nodes.
...
axis is of type [Vector3](https://docs.godotengine.org/en/stable/classes/class_vector3.html#class-vector3), and also that Godot stores
the [Basis](https://docs.godotengine.org/en/stable/classes/class_basis.html#class-basis) separately from the [Transform3D](https://docs.godotengine.org/en/stable/classes/class_transform3d.html#class-transform3d),
...
[Basis](https://docs.godotengine.org/en/stable/classes/class_basis.html#class-basis) vectors and the origin in both 2D and 3D:
...
represent quaternions using the [Quaternion](https://docs.godotengine.org/en/stable/classes/class_quaternion.html#class-quaternion) struct. My suggestion
