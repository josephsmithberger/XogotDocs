...
@Image(source: "inspector_overview.png")
...
@Image(source: "inspector_top_buttons.png")
...
@Image(source: "inspector_dock_overlay.png")
...
@Image(source: "inspector_dock_subresource.png")
...
The values with different values than their original values will have a revert icon ().
...
@Image(source: "inspector_tools_menu.png")
...
> `Action Suffix`. See <doc:gdscript_exports> for more on this topic.
>

> Seealso: Refer to <doc:customizing_editor> for dock customization options.
>
>