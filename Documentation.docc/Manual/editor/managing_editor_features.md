...
information on how to optimize Godot see <doc:index>.
...
@Image(source: "configure_profile.png")
...
@Image(source: "node_features.png")
...
See <doc:data_paths#Self-Contained-Mode> for details.