...
@Image(source: "editor_ui_resize_dock.png", alt: "Resizing a dock in the editor") {Resizing a dock in the editor}
...
@Image(source: "editor_ui_move_dock.png", alt: "Moving a dock in the editor") {Moving a dock in the editor}
...
@Image(source: "editor_ui_split_script_editor.png", alt: "Splitting the script editor to its own window") {Splitting the script editor to its own window}

To split the shader editor to its own window, click the corresponding button in
the top-right corner of the script editor:

@Image(source: "editor_ui_split_shader_editor.png", alt: "Splitting the shader editor to its own window") {Splitting the shader editor to its own window}
...
@Image(source: "editor_settings.png", alt: "The Editor Settings window") {The Editor Settings window}
...
See the [EditorSettings](https://docs.godotengine.org/en/stable/classes/class_editorsettings.html#class-editorsettings) class reference for a complete description
