...
There is a Web editor you can use to work
...
> production work**. See <doc:using_the_web_editor#Limitations> below.
>
...
> poor Firefox WebGL performance,
...
native version of the Godot editor.
...
>
> See the
> list of open issues on GitHub related to the web editor
...
project using a native Godot editor,
