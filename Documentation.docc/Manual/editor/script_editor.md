...
<doc:first_look_at_the_editor#Integrated-Class-Reference>.

@Image(source: "text_editor.png")
...
> in your project, see <doc:external_editor> and
> <doc:index#Setup-External-Editor>.
>
...
@Image(source: "editor_ui_script_editor_open.png")
...
For a complete shortcut list, see the <doc:default_key_mapping#Shortcuts-Text-Editor>.
...
@Image(source: "editor_ui_script_editor_script_panel.png")
...
to the file name. For example, the  icon means that it is a GDScript.
the  means it is a C# script. The  means that this is a
built-in class reference. Finally, the  means it is a currently running
script (See <doc:running_code_in_the_editor> for more on this).
...
@Image(source: "text_editor_menu.png")

The **File** menu provides the following options:

@Image(source: "text_editor_file_menu.png")
...
- **Run**: If the script extends [EditorScript](https://docs.godotengine.org/en/stable/classes/class_editorscript.html#class-editorscript) and
intended to be executed without running the project, this option runs the script.
See <doc:running_code_in_the_editor#Editorscript> for more.
...
`Scripts Panel` is explained <doc:script_editor#Script-Panel>.

The **Edit** menu provides several options for line operations:

@Image(source: "text_editor_edit_menu.png")
...
@Image(source: "text_editor_search_menu.png")
...
@Image(source: "editor_ui_script_editor_replaceinfiles.png")
...
@Image(source: "text_editor_goto_menu.png")
...
<doc:debugger_tools_and_options> for more.

### Coding area

> Note: This section will only cover the basics of the coding area in terms of the user
> interface. To learn more about scripting in Godot, refer to the <doc:index> or
> :ref:`Scripting <toc-learn-scripting>` documentation.
>

@Image(source: "editor_ui_script_editor_coding_area.png")
...
icon indicates that this function is an <doc:overridable_functions> of an existing
function. Clicking it opens the documentation of the original function. The  icon means
that it is a receiving method of a signal. Clicking it shows where the signal is coming
from. A  icon to the left of the line denotes a foldable block. You can
...
Line 55 is a breakpoint that can be used in <doc:overview_of_debugging_tools>.

@Image(source: "text_editor_coding_area_indicators.png")
