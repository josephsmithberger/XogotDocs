...
@Image(source: "editor_ui_intro_project_manager_01.png")

To change the editors language click on the **Settings** Button in the top right
corner:

@Image(source: "editor_ui_intro_project_manager_02.png")
...
@Image(source: "editor_ui_intro_project_manager_10.png")
...
1. Give the project a name, then open the file browser using the **Browse** button,
...
1. Select one of the renderers (this can also be changed later).

1. Click the **Create & Edit** button to create the project folder and open it in the editor.

@Image(source: "editor_ui_intro_project_manager_04.png")

> Note: You can optionally choose a version control system. Currently, only

git is supported and it needs the Godot Git Plugin to be installed,
either manually or using the <doc:using_assetlib>. To learn more about the Godot Git Plugin, see its wiki.
...
@Image(source: "editor_ui_intro_project_manager_05.png")
...
@Image(source: "editor_ui_intro_project_manager_06.png")
...
@Image(source: "editor_ui_intro_project_manager_08.png")

Alternatively, it is possible to choose a zip file to be automatically extracted by Godot.

When the folder path is correct, you'll see a green checkmark.

@Image(source: "editor_ui_intro_project_manager_09.png")
...
1. On the page that opens, click the download button.

1. Once it finished downloading, click install and choose where you want to save
the project.

@Image(source: "editor_ui_intro_project_manager_03.png")
...
@Image(source: "editor_ui_intro_project_manager_11.png")

This will open up the manage project tags window. To add a tag click the plus button.

@Image(source: "editor_ui_intro_project_manager_12.png")
