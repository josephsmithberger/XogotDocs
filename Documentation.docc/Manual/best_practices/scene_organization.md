...
> [Area2D](https://docs.godotengine.org/en/stable/classes/class_area2d.html#class-area2d) node when it has no child
> [CollisionShape2D](https://docs.godotengine.org/en/stable/classes/class_collisionshape2d.html#class-collisionshape2d) nodes defined. The editor
...
<doc:change_scenes_manually> gives you full
...
1. should be globally accessible

1. should exist in isolation

... then you should create an <doc:singletons_autoload>.
