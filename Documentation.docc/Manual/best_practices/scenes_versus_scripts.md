...
1. Create an instance of that base type.

1. Add the script to the node.
...
Scenes help to avoid this performance issue. [PackedScene](https://docs.godotengine.org/en/stable/classes/class_packedscene.html#class-packedscene), the base type that scenes inherit from, defines resources
