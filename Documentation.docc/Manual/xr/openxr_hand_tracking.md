...
@Image(source: "xr_enable_handtracking.png")
...
@Image(source: "openxr_enable_hand_tracking_meta.png")
...
@Image(source: "openxr_hand_tracking_nodes.png")
...
- Tracking happens in the local space of the [XROrigin3D](https://docs.godotengine.org/en/stable/classes/class_xrorigin3d.html#class-xrorigin3d) node.
...
For this Godot uses the hand bone structure as defined for the [Godot Humanoid](https://docs.godotengine.org/en/stable/classes/class_skeletonprofilehumanoid.html#class-skeletonprofilehumanoid)
...
Reacting to actions performed by the user is handled through <doc:xr_action_map>
...
The hand interaction profile extension
...
@Image(source: "openxr_hand_interaction_profile.png")
...
The Microsoft hand interaction profile extension
...
The HTC hand interaction profile extension
...
@Image(source: "openxr_htc_hand_interaction_profile.png")
...
@Image(source: "openxr_simple_controller_hand.png")
