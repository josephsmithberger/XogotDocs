...
where we want to place the [XROrigin3D](https://docs.godotengine.org/en/stable/classes/class_xrorigin3d.html#class-xrorigin3d) node where the player's head should be.
...
See <doc:xr_room_scale> for more information.
