...
@Image(source: "xr_action_map.png")
...
Col | Value | Description
--- | ----- | -----------
1 | aim_pose | This is the internal name of the action.
OpenXR doesn't specify specific restrictions on this name other then size, however
some XR runtimes will not like spaces or special characters.
...
@Image(source: "xr_all_actions.png")
...
If all else fails, it will check the generic <doc:xr_action_map#Simple>.
...
@Image(source: "xr_add_touch_controller.png")
...
@Image(source: "xr_touch_completed.png")
...
@Image(source: "xr_simple_controller.png")
...
for each runtime and using a custom <doc:feature_tags>
...
@Image(source: "openxr_thumbstick_dpad.png")
...
@Image(source: "openxr_project_settings_dpad_modifier.png")
...
@Image(source: "openxr_dpad_modifier.png")
...
@Image(source: "openxr_project_settings_analog_threshold_modifier.png")

The analog threshold modifier has the following settings:

@Image(source: "openxr_analog_threshold_modifier.png")
...
@Image(source: "openxr_haptic_vibration.png")
