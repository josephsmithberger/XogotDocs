...
In traditional first person games a player is represented by a [CharacterBody3D](https://docs.godotengine.org/en/stable/classes/class_characterbody3d.html#class-characterbody3d) node.
...
Applying this model to the XR setup, we add an [XROrigin3D](https://docs.godotengine.org/en/stable/classes/class_xrorigin3d.html#class-xrorigin3d) node as a child of the character body,
and add an [XRCamera3D](https://docs.godotengine.org/en/stable/classes/class_xrcamera3d.html#class-xrcamera3d) as a child of the origin node. At face value this seems to work.
...
@Image(source: "XRRoomCenterWalk.gif")
...
@Image(source: "XRRoomWalkOffCliff.gif")
...
@Image(source: "XRRoomRotateOrigin.gif")
...
@Image(source: "XRRoomWalkWall.gif")
...
@Image(source: "xr_room_scale_origin_body.png")
...
@Image(source: "xr_room_scale_character_body.png")
