...
see-through displays allowing the user
...
> so you don't need to worry about these differences, the [XRInterface](https://docs.godotengine.org/en/stable/classes/class_xrinterface.html#class-xrinterface)
> implementation is now responsible for applying the correct platform-dependent method [1].
>
> For headsets such as the Meta Quest and HTC Elite you will need to use the
> OpenXR vendors plugin v3.0.0
...
@Image(source: "openxr_default_blend_mode.png")
