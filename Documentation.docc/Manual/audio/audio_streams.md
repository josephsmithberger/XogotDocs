...
information on supported formats and differences in <doc:importing_audio_samples>.

There are other types of AudioStreams, such as [AudioStreamRandomizer](https://docs.godotengine.org/en/stable/classes/class_audiostreamrandomizer.html#class-audiostreamrandomizer).
...
@Image(source: "audio_stream_player.png")
...
@Image(source: "audio_stream_2d.png")
...
@Image(source: "audio_stream_2d_area.png")

## AudioStreamPlayer3D

@Image(source: "audio_stream_3d.png")
...
@Image(source: "audio_stream_3d_area.png")
...
> are not enabled.
>
> See <doc:exporting_for_web#Audio-Playback>
> for details.
>
...
@Image(source: "audio_stream_reverb_bus.png")
...
@Image(source: "audio_stream_reverb_bus2.png")
...
@Image(source: "audio_stream_doppler.png")
