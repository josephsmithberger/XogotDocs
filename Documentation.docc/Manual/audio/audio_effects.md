...
> a <doc:audio_buses#Limiter> is likely a better choice
...
from [Area3Ds](https://docs.godotengine.org/en/stable/classes/class_area3d.html#class-area3d)
(see <doc:audio_streams#Reverb-Buses>), or to apply
...
A demo project using this can be found here.
