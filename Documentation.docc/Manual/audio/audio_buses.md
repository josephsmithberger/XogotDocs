...
For information on what each effect does, see <doc:audio_effects>.
...
@Image(source: "audio_buses5.png") {Disabled buses have a blue VU meter instead of a red-green one.}
