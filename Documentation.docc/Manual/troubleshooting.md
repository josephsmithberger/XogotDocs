...
> Seealso:
>
> See <doc:using_the_web_editor> for caveats specific to the Web version
> of the Godot editor.
>
...
@Image(source: "troubleshooting_graphics_driver_sharpening.png", alt: "Correct appearance (left), oversharpened appearance due to graphics driver sharpening (right)") {Correct appearance (left), oversharpened appearance due to graphics driver sharpening (right)}
...
option to preserve video memory after suspend
...
crashes. See the <doc:project_manager> for more
information.