...
The Godot Engine for Android platforms is designed to be used as an Android library.
...
For more information, see <doc:android_plugin>.
...
The GLTF Viewer sample app uses an Android RecyclerView component to create
a list of glTF items, populated from Kenney's Food Kit pack.
...
@Image(source: "gltf_viewer_sample_app_screenshot.png")

The sample app source code can be found on GitHub.
Follow the instructions on its README to build and install it.
...
> You can configure the process the Android Activity runs under using the android:process attribute.
>
...
> Note:
>
> The Android sample app was created using Android Studio
> and using Gradle as the build system.
>
