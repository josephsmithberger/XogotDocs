...
These don't make sense in Godot core itself so Godot has long provided an <doc:android_plugin>.
The <doc:android_plugin> enables developers to create Godot Android plugins using Java or Kotlin code,
