...
Follow the compiling instructions on the GodotGooglePlayBilling github page.
...
1. Connect handlers for the plugin signals

1. Call startConnection
...
queryPurchases(), see Processing a purchase item
...
1. The product id string of the subscription SKU to change to

1. The proration mode to apply to the subscription.
