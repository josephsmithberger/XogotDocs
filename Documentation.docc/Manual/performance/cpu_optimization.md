...
@Image(source: "godot_profiler.png", alt: "Screenshot of the Godot profiler") {Results of a profile of one of the demo projects.}
...
You can <doc:using_cpp_profilers>
to do this.

@Image(source: "valgrind.png", alt: "Screenshot of Callgrind") {Example results from Callgrind, which is part of Valgrind.}
...
<doc:index> is designed to be easy to use and iterate,
...
<doc:index> is popular and has first-class support in Godot. It
...
For more information on threads, see <doc:using_multiple_threads>.
...
One quirk of the [SceneTree](https://docs.godotengine.org/en/stable/classes/class_scenetree.html#class-scenetree) is that you can sometimes
