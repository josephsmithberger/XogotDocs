...
Godot sorts objects by [Material](https://docs.godotengine.org/en/stable/classes/class_material.html#class-material) and [Shader](https://docs.godotengine.org/en/stable/classes/class_shader.html#class-shader) to improve performance. This, however, can not be done with
...
For more information, see the <doc:gpu_optimization>
doc.
...
- An automatic approach on mesh import using <doc:mesh_lod>.

- A manual approach configured in the 3D node using <doc:visibility_ranges>.

- <doc:using_decals> and <doc:lights_and_shadows>
...
using [MultiMesh](https://docs.godotengine.org/en/stable/classes/class_multimesh.html#class-multimesh) instead. MultiMesh allows the drawing
...
See <doc:using_lightmap_gi> for instructions on using baked lightmaps. For
...
and quality is to keep **Dynamic** for the [DirectionalLight3D](https://docs.godotengine.org/en/stable/classes/class_directionallight3d.html#class-directionallight3d) node,
...
The [VisibleOnScreenEnabler3D](https://docs.godotengine.org/en/stable/classes/class_visibleonscreenenabler3d.html#class-visibleonscreenenabler3d) and [VisibleOnScreenNotifier3D](https://docs.godotengine.org/en/stable/classes/class_visibleonscreennotifier3d.html#class-visibleonscreennotifier3d)
...
large worlds. This can be resolved using <doc:large_world_coordinates>.
