...
[CanvasItem](https://docs.godotengine.org/en/stable/classes/class_canvasitem.html#class-canvasitem) is the base for all 2D nodes, be it regular
2D nodes, such as [Node2D](https://docs.godotengine.org/en/stable/classes/class_node2d.html#class-node2d), or [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control).
Both inherit from [CanvasItem](https://docs.godotengine.org/en/stable/classes/class_canvasitem.html#class-canvasitem).
...
The answer is [CanvasLayer](https://docs.godotengine.org/en/stable/classes/class_canvaslayer.html#class-canvaslayer),
