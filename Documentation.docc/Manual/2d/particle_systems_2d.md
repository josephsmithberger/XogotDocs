...
Godot provides two different nodes for 2D particles, [GPUParticles2D](https://docs.godotengine.org/en/stable/classes/class_gpuparticles2d.html#class-gpuparticles2d)
and [CPUParticles2D](https://docs.godotengine.org/en/stable/classes/class_cpuparticles2d.html#class-cpuparticles2d). GPUParticles2D is more advanced and uses the
...
While GPUParticles2D is configured via a [ParticleProcessMaterial](https://docs.godotengine.org/en/stable/classes/class_particleprocessmaterial.html#class-particleprocessmaterial)
...
@Image(source: "particles_convert.png")
...
flipbook images online, or pre-render them using external tools such as Blender or EmberGen.

@Image(source: "particles_flipbook_result.png", alt: "Example of a particle system that uses a flipbook texture") {Example of a particle system that uses a flipbook texture}
...
@Image(source: "particles_flipbook_example.png", alt: "Particle flipbook texture example") {Credit: JoesAlotofthings
(CC BY 4.0)}
...
@Image(source: "particles_flipbook_create_canvasitemmaterial.png", alt: "Creating a CanvasItemMaterial at the bottom of the particles node inspector") {Creating a CanvasItemMaterial at the bottom of the particles node inspector}
...
@Image(source: "particles_flipbook_configure_canvasitemmaterial.png", alt: "Configuring the CanvasItemMaterial for the example flipbook texture") {Configuring the CanvasItemMaterial for the example flipbook texture}

Once this is done, the <doc:particle_systems_2d#Animation>
...
> have a transparent background in an image editor. In GIMP,
...
@Image(source: "paranim14.gif")

Lifetime: 4.0

@Image(source: "paranim15.gif")
...
For information on the settings in the ParticleProcessMaterial see <doc:particle_process_material_2d>.