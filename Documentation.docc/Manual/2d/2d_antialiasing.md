...
geometry edges, and are most noticeable when using nodes such as [Line2D](https://docs.godotengine.org/en/stable/classes/class_line2d.html#class-line2d),
[Polygon2D](https://docs.godotengine.org/en/stable/classes/class_polygon2d.html#class-polygon2d) or [TextureProgressBar](https://docs.godotengine.org/en/stable/classes/class_textureprogressbar.html#class-textureprogressbar). <doc:custom_drawing_in_2d>
...
@Image(source: "antialiasing_none_scaled.png", alt: "Image is scaled by 2× with nearest-neighbor filtering to make aliasing more noticeable.") {Image is scaled by 2× with nearest-neighbor filtering to make aliasing more noticeable.}
...
@Image(source: "antialiasing_msaa_2x.png")

@Image(source: "antialiasing_msaa_4x.png")

@Image(source: "antialiasing_msaa_8x.png")