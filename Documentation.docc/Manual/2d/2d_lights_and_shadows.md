...
@Image(source: "2d_lights_and_shadows_disabled.png", alt: "No 2D lights or shadows, scene is unshaded") {No 2D lights or shadows, scene is unshaded}

@Image(source: "2d_lights_and_shadows_enabled_no_shadows.png", alt: "2D lights enabled (without shadows)") {2D lights enabled (without shadows)}

@Image(source: "2d_lights_and_shadows_enabled.png", alt: "2D lights and shadows enabled") {2D lights and shadows enabled}
...
[CanvasModulate](https://docs.godotengine.org/en/stable/classes/class_canvasmodulate.html#class-canvasmodulate) is used to darken the scene by
...
[Sprite2Ds](https://docs.godotengine.org/en/stable/classes/class_sprite2d.html#class-sprite2d) are used to display the textures for the light
blobs, the background, and for the shadow casters.

[PointLight2Ds](https://docs.godotengine.org/en/stable/classes/class_pointlight2d.html#class-pointlight2d) are used to light the scene. The way a
light typically works is by adding a selected texture over the rest of the scene
to simulate lighting.

[LightOccluder2Ds](https://docs.godotengine.org/en/stable/classes/class_lightoccluder2d.html#class-lightoccluder2d) are used to tell the shader
...
The shadows appear only on areas covered by the [PointLight2D](https://docs.godotengine.org/en/stable/classes/class_pointlight2d.html#class-pointlight2d) and their direction is based on the center of the
[Light](https://docs.godotengine.org/en/stable/classes/class_pointlight2d.html#class-pointlight2d).
...
@Image(source: "2d_lights_and_shadows_neutral_point_light.png", alt: "Neutral point light texture") {Neutral point light texture}
...
>
> For more information on canvas item shaders, see <doc:canvas_item_shader>.
>

@Image(source: "2d_lights_and_shadows_hard_shadow.png", alt: "Hard shadows") {Hard shadows}

@Image(source: "2d_lights_and_shadows_soft_shadow.png", alt: "Soft shadows (PCF13, Filter Smooth 1.5)") {Soft shadows (PCF13, Filter Smooth 1.5)}
...
> them using the free and open source Laigter
> tool.
>
...
@Image(source: "2d_lights_and_shadows_create_canvastexture.png", alt: "Creating a CanvasTexture resource for a Sprite2D node") {Creating a CanvasTexture resource for a Sprite2D node}
