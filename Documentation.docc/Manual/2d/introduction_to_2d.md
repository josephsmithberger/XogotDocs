...
> Tip: If you would like to get an introduction to 3D, see <doc:introduction_to_3d>.
>
...
@Image(source: "2d_editor_guidelines.png")
...
<doc:introduction_to_2d#The-Viewport> more on rulers.
...
[CanvasItem](https://docs.godotengine.org/en/stable/classes/class_canvasitem.html#class-canvasitem) is the base node for 2D. [Node2D](https://docs.godotengine.org/en/stable/classes/class_node2d.html#class-node2d) is the base node
for 2D game objects, and [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control) is the base node
for everything GUI. For 3D, Godot uses the [Node3D](https://docs.godotengine.org/en/stable/classes/class_node3d.html#class-node3d) node.
