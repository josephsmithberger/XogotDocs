...
The backbone of the parallax effect is the [scroll_scale](https://docs.godotengine.org/en/stable/classes/class_parallax2d_property_scroll_scale.html#class-parallax2d_property_scroll_scale) property.
...
[repeat_size](https://docs.godotengine.org/en/stable/classes/class_parallax2d_property_repeat_size.html#class-parallax2d_property_repeat_size) tells the node to snap its position forward or back when the
...
size or larger than your viewport **before** setting the [repeat_size](https://docs.godotengine.org/en/stable/classes/class_parallax2d_property_repeat_size.html#class-parallax2d_property_repeat_size). If
...
[repeat_size](https://docs.godotengine.org/en/stable/classes/class_parallax2d_property_repeat_size.html#class-parallax2d_property_repeat_size) to the size of our image, the infinite repeat effect doesn't
scroll properly because the original texture doesn't cover the viewport. If we set the
[repeat_size](https://docs.godotengine.org/en/stable/classes/class_parallax2d_property_repeat_size.html#class-parallax2d_property_repeat_size) to the size of the viewport, we have a large gap. What can we
do?
...
[Viewport Width](https://docs.godotengine.org/en/stable/classes/class_projectsettings_property_display/window/size/viewport_width.html#class-projectsettings_property_display/window/size/viewport_width)
and [Viewport Height](https://docs.godotengine.org/en/stable/classes/class_projectsettings_property_display/window/size/viewport_height.html#class-projectsettings_property_display/window/size/viewport_height)
...
larger to fit your screen. Set the [scale](https://docs.godotengine.org/en/stable/classes/class_node2d_property_scale.html#class-node2d_property_scale) of the [Parallax2D](https://docs.godotengine.org/en/stable/classes/class_parallax2d.html#class-parallax2d),
...
[Parallax2D.repeat_size](https://docs.godotengine.org/en/stable/classes/class_parallax2d_property_repeat_size.html#class-parallax2d_property_repeat_size) and
[Sprite2D.region_rect](https://docs.godotengine.org/en/stable/classes/class_sprite2d_property_region_rect.html#class-sprite2d_property_region_rect) do not take scaling into account, so it's necessary to
...
(determined by [repeat_size](https://docs.godotengine.org/en/stable/classes/class_parallax2d_property_repeat_size.html#class-parallax2d_property_repeat_size)), and when it reaches what's inside the yellow
...
the [Viewport.world_2d](https://docs.godotengine.org/en/stable/classes/class_viewport_property_world_2d.html#class-viewport_property_world_2d) of the first SubViewport to the second, so they have a
...
- Leave all parallax nodes at their default [visibility_layer](https://docs.godotengine.org/en/stable/classes/class_canvasitem_property_visibility_layer.html#class-canvasitem_property_visibility_layer) of 1.

- Set the first SubViewport's [canvas_cull_mask](https://docs.godotengine.org/en/stable/classes/class_viewport_property_canvas_cull_mask.html#class-viewport_property_canvas_cull_mask) to only layers 1 and 2.

- Do the same for the second SubViewport but use layers 1 and 3.

- Give your parallax nodes in the first SubViewport a common parent and set its [visibility_layer](https://docs.godotengine.org/en/stable/classes/class_canvasitem_property_visibility_layer.html#class-canvasitem_property_visibility_layer) to 2.

- Do the same for the second SubViewport's parallax nodes, but use a layer of 3.

How does this work? If a canvas item has a [visibility_layer](https://docs.godotengine.org/en/stable/classes/class_canvasitem_property_visibility_layer.html#class-canvasitem_property_visibility_layer) that
doesn't match the SubViewport's [canvas_cull_mask](https://docs.godotengine.org/en/stable/classes/class_viewport_property_canvas_cull_mask.html#class-viewport_property_canvas_cull_mask), it will hide all
children, even if they do. We use this to our advantage, letting the SubViewports cut off rendering of parallax nodes
whose parent doesn't have a supported [visibility_layer](https://docs.godotengine.org/en/stable/classes/class_canvasitem_property_visibility_layer.html#class-canvasitem_property_visibility_layer).
...
[follow_viewport_enabled](https://docs.godotengine.org/en/stable/classes/class_canvaslayer_property_follow_viewport_enabled.html#class-canvaslayer_property_follow_viewport_enabled) property, and scale the individual
