...
try and access an imported asset using the [FileAccess](https://docs.godotengine.org/en/stable/classes/class_fileaccess.html#class-fileaccess) class,
it will work in the editor, but **it will break in the exported project**.

However, the [Resource Loader](https://docs.godotengine.org/en/stable/classes/class_resourceloader.html#class-resourceloader) cannot access
non-imported files. Only the [FileAccess](https://docs.godotengine.org/en/stable/classes/class_fileaccess.html#class-fileaccess) class can.
...
@Image(source: "import_process_example.png")
...
@Image(source: "reimport_multiple.png")
...
@Image(source: "import_process_change_preset.png")
...
@Image(source: "import_process_import_defaults.png")
