...
web-based viewer.
For complex vectors, rendering them to PNGs using Inkscape
...
without converting them back to an [Image](https://docs.godotengine.org/en/stable/classes/class_image.html#class-image) in a script. This is what
...
@Image(source: "importing_images_import_dock.png", alt: "Import options in the Import dock after selecting an image in the FileSystem dock") {Import options in the Import dock after selecting an image in the FileSystem dock.
...
all characters have the same width. See <doc:gui_using_fonts>.
...
texture arrays, so you must create a custom shader in <doc:canvas_item_shader>
or <doc:spatial_shader> to display a texture from a texture array.
...
[FogMaterial](https://docs.godotengine.org/en/stable/classes/class_fogmaterial.html#class-fogmaterial) density maps in <doc:volumetric_fog>, <doc:index#Attractors>
vector fields, [Environment](https://docs.godotengine.org/en/stable/classes/class_environment.html#class-environment) 3D LUT color correction, and custom shaders.
...
[BaseMaterial3D](https://docs.godotengine.org/en/stable/classes/class_basematerial3d.html#class-basematerial3d)). If this happens, several import options are
...
<doc:importing_images#Detect-3d-Compress-To> is changed. The texture is
...
<doc:importing_images#Detect-3d-Compress-To> option before using the
texture in 3D, or change <doc:importing_images#Compress-Mode> to
...
@Image(source: "importing_images_inspector_preview.png", alt: "Previewing a texture in the Inspector") {Previewing a texture in the Inspector. Credit: Red Brick 03 - Poly Haven}
...
@Image(source: "importing_images_normal_map_rgtc.png", alt: "Normal map with standard VRAM compression (left) and with RGTC VRAM compression (right)") {Normal map with standard VRAM compression (left) and with RGTC VRAM compression (right)}
...
textures ([Cubemap](https://docs.godotengine.org/en/stable/classes/class_cubemap.html#class-cubemap), [CubemapArray](https://docs.godotengine.org/en/stable/classes/class_cubemaparray.html#class-cubemaparray), [Texture2DArray](https://docs.godotengine.org/en/stable/classes/class_texture2darray.html#class-texture2darray)
and [Texture3D](https://docs.godotengine.org/en/stable/classes/class_texture3d.html#class-texture3d)). This forces all layers from the texture to be imported
...
This changes the <doc:importing_images#Compress-Mode> option that is used
...
To support <doc:multiple_resolutions> with crisp
...
> <doc:runtime_file_loading_and_saving_images>,
