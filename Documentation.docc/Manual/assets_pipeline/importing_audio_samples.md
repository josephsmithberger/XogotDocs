...
@Image(source: "importing_audio_samples_import_options_wav.png", alt: "Import options in the Import dock after selecting a WAV file in the FileSystem dock") {Import options in the Import dock after selecting a WAV file in the FileSystem dock}

The set of options available after selecting an Ogg Vorbis or MP3 file is different:

@Image(source: "importing_audio_samples_import_options_mp3.png", alt: "Import options in the Import dock after selecting an MP3 file in the FileSystem dock") {Import options in the Import dock after selecting an MP3 file in the
...
AudioStreamPlayer2D or AudioStreamPlayer3D nodes. See <doc:audio_streams>
...
<doc:importing_audio_samples#Best-Practices> for more information.
...
<doc:importing_audio_samples#Advanced-Import-Settings>
...
@Image(source: "importing_audio_samples_advanced_import_settings.png", alt: "Advanced dialog when double-clicking an Ogg Vorbis or MP3 file in the FileSystem dock") {Advanced dialog when double-clicking an Ogg Vorbis or MP3 file in the FileSystem dock}
...
Godot has an <doc:audio_buses> with built-in effects.
...
> <doc:runtime_file_loading_and_saving_audio_video_files>,
