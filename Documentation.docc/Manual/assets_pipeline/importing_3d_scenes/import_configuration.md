...
<doc:model_export_considerations> and
<doc:node_type_customization> articles
...
@Image(source: "importing_3d_scenes_import_dock.png", alt: "Import dock after selecting a 3D scene in the FileSystem dock") {Import dock after selecting a 3D scene in the FileSystem dock}
...
- <doc:node_type_customization>, which are special
...
Mikktspace if the input meshes don't have
...
See <doc:mesh_lod> for more information.
...
See <doc:index#Import-Script> for more information.
...
@Image(source: "importing_3d_scenes_advanced_import_settings_scene.png", alt: "Advanced Import Settings dialog (Scene tab)") {Advanced Import Settings dialog (Scene tab).
...
@Image(source: "importing_3d_scenes_advanced_import_settings_node.png", alt: "Selecting a node in the Advanced Import Settings dialog (Scene tab)") {Selecting a node in the Advanced Import Settings dialog (Materials tab)}
...
node for <doc:navigation_introduction_3d>. **Mesh + NavMesh**
...
node for <doc:occlusion_culling> using the mesh's
...
@Image(source: "importing_3d_scenes_advanced_import_settings_meshes.png", alt: "Advanced Import Settings dialog (Meshes tab)") {Advanced Import Settings dialog (Meshes tab)}

The options are as follows:

- **Save to File:** Saves the [Mesh](https://docs.godotengine.org/en/stable/classes/class_mesh.html#class-mesh) resource to an external file
...
<doc:index#Using-The-Import-Dock>. **Default** will use the
...
@Image(source: "importing_3d_scenes_advanced_import_settings_materials.png", alt: "Advanced Import Settings dialog (Materials tab)") {Advanced Import Settings dialog (Materials tab)}
...
@Image(source: "importing_3d_scenes_changing_import_type.png", alt: "Changing the import type to Animation Library in the Import dock") {Changing the import type to Animation Library in the Import dock}

Click **Reimport** and restart the editor when prompted. After restarting, the
glTF file will be imported as an [AnimationLibrary](https://docs.godotengine.org/en/stable/classes/class_animationlibrary.html#class-animationlibrary) instead of a
[PackedScene](https://docs.godotengine.org/en/stable/classes/class_packedscene.html#class-packedscene). This animation library can then be referenced in an
...
<doc:index#Using-The-Import-Dock> for more information.
...
@Image(source: "importing_3d_scenes_create_inherited_scene_dialog.png", alt: "Dialog when opening an imported 3D scene in the editor") {Dialog when opening an imported 3D scene in the editor}
