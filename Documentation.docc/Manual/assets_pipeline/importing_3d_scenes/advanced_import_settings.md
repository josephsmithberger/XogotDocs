...
@Image(source: "importing_3d_scenes_advanced_import_settings_button.png")
...
Several extra options are available for the generated [AnimationPlayer](https://docs.godotengine.org/en/stable/classes/class_animationplayer.html#class-animationplayer)
