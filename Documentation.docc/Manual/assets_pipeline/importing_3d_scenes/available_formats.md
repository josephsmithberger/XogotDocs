...
- FBX, supported via the ufbx library. The
previous import workflow used FBX2glTF
...
@Image(source: "importing_3d_scenes_available_formats_gltf_runtime.png", alt: "Diagram explaining the runtime import and export process for glTF files in Godot")
...
@Image(source: "importing_3d_scenes_available_formats_gltf_editor.png", alt: "Diagram explaining the editor import process for glTF files in Godot")
...
scenes, such as unwrapping UV2 on import (for <doc:using_lightmap_gi>).
...
@Image(source: "importing_3d_scenes_available_formats_fbx.png", alt: "Diagram explaining the import process for FBX files in Godot  via FBX2glTF")
