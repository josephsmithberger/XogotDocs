...
With the Skeleton node selected, first set up a new [bonemap](https://docs.godotengine.org/en/stable/classes/class_bonemap.html#class-bonemap) and [skeletonprofile](https://docs.godotengine.org/en/stable/classes/class_skeletonprofile.html#class-skeletonprofile).
Godot has a preset called [skeletonprofilehumanoid](https://docs.godotengine.org/en/stable/classes/class_skeletonprofilehumanoid.html#class-skeletonprofilehumanoid) for humanoid models.
This tutorial proceeds with the assumption that you are using [skeletonprofilehumanoid](https://docs.godotengine.org/en/stable/classes/class_skeletonprofilehumanoid.html#class-skeletonprofilehumanoid).

> Note: If you need a profile that is different from [skeletonprofilehumanoid](https://docs.godotengine.org/en/stable/classes/class_skeletonprofilehumanoid.html#class-skeletonprofilehumanoid), you can export
> a [skeletonprofile](https://docs.godotengine.org/en/stable/classes/class_skeletonprofile.html#class-skeletonprofile) from the editor by selecting a Skeleton3D and using the **Skeleton3D** menu in the 3D viewport's toolbar.
>

When you use [skeletonprofilehumanoid](https://docs.godotengine.org/en/stable/classes/class_skeletonprofilehumanoid.html#class-skeletonprofilehumanoid), auto-mapping will be performed when the
[skeletonprofile](https://docs.godotengine.org/en/stable/classes/class_skeletonprofile.html#class-skeletonprofile) is set. If the auto-mapping does not work well, you can map bones manually.

@Image(source: "retargeting2.png")
...
If you import resources as an [animationlibrary](https://docs.godotengine.org/en/stable/classes/class_animationlibrary.html#class-animationlibrary) that will be shared, we recommend to enable these options.
...
Reference poses defined in [skeletonprofilehumanoid](https://docs.godotengine.org/en/stable/classes/class_skeletonprofilehumanoid.html#class-skeletonprofilehumanoid) have the following rules:
...
Attempts to make the model's silhouette match that of the reference poses defined in the [skeletonprofile](https://docs.godotengine.org/en/stable/classes/class_skeletonprofile.html#class-skeletonprofile),
