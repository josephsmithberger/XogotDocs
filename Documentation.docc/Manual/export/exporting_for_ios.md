...
@Image(source: "ios_export_file.png")
...
1. In Finder, drag the Godot project folder into the Xcode file browser.
...
@Image(source: "ios_export_set_path.png")
...
[EditorExportPlatformIOS](https://docs.godotengine.org/en/stable/classes/class_editorexportplatformios.html#class-editorexportplatformios) class reference.