...
@Image(source: "feature_tags1.png")
...
@Image(source: "feature_tags2.png", alt: "The Project Settings panel") {The desired configuration is selected, which effectively copies its properties to the panel above (1). The "demo_build" feature tag is selected (2). The configuration is added to the project settings (3).}

After overriding, a new field is added for this specific configuration.

@Image(source: "feature_tags3.png")

> Note:
>
> When using the
> [project settings "override.cfg" functionality](https://docs.godotengine.org/en/stable/classes/class_projectsettings.html#class-projectsettings)
...
@Image(source: "feature_tags4.png")
