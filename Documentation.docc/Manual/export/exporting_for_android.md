...
> read <doc:compiling_for_android>.
>
...
> is experimental and <doc:index#Platforms>.
>
...
@Image(source: "editorsettings.png")

Scroll down to the section where the Android settings are located:

@Image(source: "android_editor_settings.png")
...
Use Google's Android Developer guides to learn more about app signing.

Now fill in the following forms in your Android Export Presets:

@Image(source: "editor-export-presets-android.png")
...
@Image(source: "export-with-debug-button.png")
...
only the features you need. See <doc:optimizing_for_size> for more
information.
...
[EditorExportPlatformAndroid](https://docs.godotengine.org/en/stable/classes/class_editorexportplatformandroid.html#class-editorexportplatformandroid) class reference.