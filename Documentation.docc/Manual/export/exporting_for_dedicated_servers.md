...
@Image(source: "exporting_for_dedicated_servers_export_resources.png", alt: "Choosing resources to keep, keep with stripped visuals or remove") {Choosing resources to keep, keep with stripped visuals or remove}
...
dedicated server in a Docker container. This way,
