...
> read <doc:compiling_for_web>.
>

HTML5 export allows publishing games made in Godot Engine to the browser.
This requires support for WebAssembly and WebGL 2.0
in the user's browser.

> Attention:
>
> Projects written in C# using Godot 4 currently cannot be exported to the
> web. See this blog post
...
> Poki or CrazyGames. The single-threaded export
...
>
> See the
> list of open issues on GitHub related to the web export
...
See Can I use WebGL 2.0 for a list of browser
...
<doc:exporting_for_android> and <doc:exporting_for_ios>
...
WebAssembly instead of native code). See <doc:index> section of the
documentation for advice on optimizing your project. If your project runs on
platforms other than Web, you can use <doc:feature_tags> to apply
...
- <doc:audio_streams#Reverb-Buses> effects are not supported.
...
[AudioStreamPlayer](https://docs.godotengine.org/en/stable/classes/class_audiostreamplayer.html#class-audiostreamplayer), [AudioStreamPlayer2D](https://docs.godotengine.org/en/stable/classes/class_audiostreamplayer2d.html#class-audiostreamplayer2d) or
[AudioStreamPlayer3D](https://docs.godotengine.org/en/stable/classes/class_audiostreamplayer3d.html#class-audiostreamplayer3d) node. This leads to increased latency
...
<doc:using_multiple_threads> to improve
...
<doc:exporting_for_web#Serving-The-Files> section below.

If **Extensions Support** is enabled, <doc:what_is_gdextension>
...
> <doc:javascript_secure_contexts>.
>
...
Currently, only <doc:http_client_class>,
<doc:http_request_class>,
<doc:websocket> and <doc:webrtc> are
supported.
...
used, see <doc:customizing_html5_shell>.

> Warning:
>
> Only when exporting with **Use Threads**, to ensure low audio latency and the
> ability to use [Thread](https://docs.godotengine.org/en/stable/classes/class_thread.html#class-thread) in web exports, Godot 4 web exports use
> SharedArrayBuffer.
> This requires a <doc:javascript_secure_contexts>,
...
(supports manual gzip precompression)
...
See the <doc:javascript_bridge> on how to interact
...
[EditorExportPlatformWeb](https://docs.godotengine.org/en/stable/classes/class_editorexportplatformweb.html#class-editorexportplatformweb) class reference.