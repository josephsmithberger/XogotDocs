...
> <doc:changing_application_icon_for_windows#Changing-The-File-Icon>
...
This video tutorial goes over how to
...
@Image(source: "icon_taskbar_icon.png")
...
external tools using godoticon.
...
@Image(source: "icon_file_icon.png")
...
@Image(source: "icon_export_settings.png")

> Note:
>
> If rcedit fails to change the icon, you can instead
> <doc:compiling_for_windows>
