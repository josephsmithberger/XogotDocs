...
@Image(source: "nav_actor_doors.png")
...
See <doc:navigation_using_navigationlayers> for more information on how to work with navigation layers and the bitmask.

@Image(source: "nav_actor_doorbitmask.png")
