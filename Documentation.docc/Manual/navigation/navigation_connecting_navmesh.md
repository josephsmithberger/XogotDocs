...
To connect over arbitrary distances see <doc:navigation_using_navigationlinks>.

@Image(source: "navigation_vertex_merge.png")
...
@Image(source: "navigation_vertex_merge2.png")
...
@Image(source: "navigation_edge_connection.png")
